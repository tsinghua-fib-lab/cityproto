...
// @generated from file city/water/input/v1/config.proto (package city.water.input.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message city.water.input.v1.Mongo
 */
export declare class Mongo extends Message<Mongo> {
  ...
  /**
   * @generated from field: city.config.v1.MongoPath rain = 3;
   */
  rain?: MongoPath;
  ...
  static readonly typeName = "city.water.input.v1.Mongo";
...
/**
 * @generated from message city.water.input.v1.ControlStep
 */
export declare class ControlStep extends Message<ControlStep> {
  ...
  /**
   * @generated from field: double interval = 3;
   */
  interval: number;
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "city.water.input.v1.ControlStep";
  static readonly fields: FieldList;
...
/**
 * @generated from message city.water.input.v1.Control
 */
export declare class Control extends Message<Control> {
  /**
   * @generated from field: city.water.input.v1.ControlStep step = 1;
   */
  step?: ControlStep;
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "city.water.input.v1.Control";
  static readonly fields: FieldList;
 ...
 * 是否输出各类数据
 *
 * @generated from message city.water.input.v1.OutputSwitch
 */
export declare class OutputSwitch extends Message<OutputSwitch> {
  /**
   * @generated from field: bool road = 1;
   */
  road: boolean;

  /**
   * @generated from field: bool drainage = 2;
   */
  drainage: boolean;

  /**
   * @generated from field: bool supply = 3;
   */
  supply: boolean;

  /**
   * @generated from field: bool aoi = 4;
   */
  aoi: boolean;

  /**
   * @generated from field: bool event = 5;
   */
  event: boolean;
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "city.water.input.v1.OutputSwitch";
  static readonly fields: FieldList;
...
/**
 * @generated from message city.water.input.v1.Output
 */
export declare class Output extends Message<Output> {
  ...
  /**
   * @generated from field: city.water.input.v1.OutputSwitch switch = 2;
   */
  switch?: OutputSwitch;
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "city.water.input.v1.Output";
  static readonly fields: FieldList;
...
/**
 * @generated from message city.water.input.v1.Config
 */
export declare class Config extends Message<Config> {
  /**
   * @generated from field: city.water.input.v1.Mongo mongo = 1;
   */
  mongo?: Mongo;

  /**
   * @generated from field: city.water.input.v1.Control control = 2;
   */
  control?: Control;

  /**
   * @generated from field: city.water.input.v1.Output output = 3;
   */
  output?: Output;
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "city.water.input.v1.Config";
  static readonly fields: FieldList;
