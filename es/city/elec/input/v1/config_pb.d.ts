...
export declare class Mongo extends Message<Mongo> {
  ...
  /**
   * @generated from field: city.config.v1.MongoPath facilities = 3;
   */
  facilities?: MongoPath;

  constructor(data?: PartialMessage<Mongo>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "city.elec.input.v1.Mongo";
...
export declare class ControlStep extends Message<ControlStep> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "city.elec.input.v1.ControlStep";
  static readonly fields: FieldList;
...
export declare class Control extends Message<Control> {
  /**
   * @generated from field: city.elec.input.v1.ControlStep step = 1;
   */
  step?: ControlStep;
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "city.elec.input.v1.Control";
  static readonly fields: FieldList;
...
export declare class OutputSwitch extends Message<OutputSwitch> {
  ...
  /**
   * @generated from field: bool aoi = 2;
   */
  aoi: boolean;
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "city.elec.input.v1.OutputSwitch";
  static readonly fields: FieldList;
...
export declare class Output extends Message<Output> {
  ...
  /**
   * @generated from field: city.elec.input.v1.OutputSwitch switch = 2;
   */
  switch?: OutputSwitch;
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "city.elec.input.v1.Output";
  static readonly fields: FieldList;
...
export declare class Config extends Message<Config> {
  /**
   * @generated from field: city.elec.input.v1.Mongo mongo = 1;
   */
  mongo?: Mongo;

  /**
   * @generated from field: city.elec.input.v1.Control control = 2;
   */
  control?: Control;

  /**
   * @generated from field: city.elec.input.v1.Output output = 3;
   */
  output?: Output;
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "city.elec.input.v1.Config";
  static readonly fields: FieldList;
