...
export const PersonService = {
  ...
  methods: {
     ...
     *
     * @generated from rpc city.person.v2.PersonService.SetPersonAttribute
     */
    setPersonAttribute: {
      name: "SetPersonAttribute",
      I: SetPersonAttributeRequest,
      O: SetPersonAttributeResponse,
      kind: MethodKind.Unary,
    },
    /**
     * 设置由外部控制行为的vehicle
