...
export const VehicleRuntime = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 15, name: "estimated_total_running_distance", kind: "scalar", T: 1 /* ScalarType.DOUBLE */ },
    { no: 16, name: "running_time", kind: "scalar", T: 1 /* ScalarType.DOUBLE */ },
    { no: 6, name: "running_distance", kind: "scalar", T: 1 /* ScalarType.DOUBLE */ },
    { no: 18, name: "running_ratio", kind: "scalar", T: 1 /* ScalarType.DOUBLE */ },
    { no: 19, name: "avg_v", kind: "scalar", T: 1 /* ScalarType.DOUBLE */ },
    { no: 7, name: "num_going_astray", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 20, name: "num_queuing_on_lane", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 21, name: "total_queuing_time", kind: "scalar", T: 1 /* ScalarType.DOUBLE */ },
    { no: 22, name: "avg_queuing_time", kind: "scalar", T: 1 /* ScalarType.DOUBLE */ },
    { no: 23, name: "num_passing_traffic_lights", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
