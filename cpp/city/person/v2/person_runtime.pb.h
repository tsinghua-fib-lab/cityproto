...
#ifndef GOOGLE_PROTOBUF_INCLUDED_city_2fperson_2fv2_2fperson_5fruntime_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_city_2fperson_2fv2_2fperson_5fruntime_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_city_2fperson_2fv2_2fperson_5fruntime_2eproto
...
struct TableStruct_city_2fperson_2fv2_2fperson_5fruntime_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_city_2fperson_2fv2_2fperson_5fruntime_2eproto;
namespace city {
namespace person {
namespace v2 {
class PersonRuntime;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::city::person::v2::PersonRuntime* Arena::CreateMaybeMessage<::city::person::v2::PersonRuntime>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace city {
namespace person {
namespace v2 {
...
class PersonRuntime final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:city.person.v2.PersonRuntime) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "city.person.v2.PersonRuntime";
  }
  protected:
  ...
  public:
  void clear_base();
  const ::city::person::v2::Person& base() const;
  PROTOBUF_NODISCARD ::city::person::v2::Person* release_base();
  ::city::person::v2::Person* mutable_base();
  void set_allocated_base(::city::person::v2::Person* base);
  private:
  const ::city::person::v2::Person& _internal_base() const;
  ::city::person::v2::Person* _internal_mutable_base();
  public:
  void unsafe_arena_set_allocated_base(
      ::city::person::v2::Person* base);
  ::city::person::v2::Person* unsafe_arena_release_base();
  ...
  // @@protoc_insertion_point(class_scope:city.person.v2.PersonRuntime)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ...
    ::city::person::v2::Person* base_;
    ::city::person::v2::PersonMotion* motion_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_city_2fperson_2fv2_2fperson_5fruntime_2eproto;
};
// ===================================================================
...
inline const ::city::person::v2::Person& PersonRuntime::_internal_base() const {
  const ::city::person::v2::Person* p = _impl_.base_;
  return p != nullptr ? *p : reinterpret_cast<const ::city::person::v2::Person&>(
      ::city::person::v2::_Person_default_instance_);
}
inline const ::city::person::v2::Person& PersonRuntime::base() const {
  // @@protoc_insertion_point(field_get:city.person.v2.PersonRuntime.base)
...
inline void PersonRuntime::unsafe_arena_set_allocated_base(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:city.person.v2.PersonRuntime.base)
}
inline ::city::person::v2::Person* PersonRuntime::release_base() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::city::person::v2::Person* temp = _impl_.base_;
...
inline ::city::person::v2::Person* PersonRuntime::unsafe_arena_release_base() {
  // @@protoc_insertion_point(field_release:city.person.v2.PersonRuntime.base)
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::city::person::v2::Person* temp = _impl_.base_;
  _impl_.base_ = nullptr;
  return temp;
}
inline ::city::person::v2::Person* PersonRuntime::_internal_mutable_base() {
  _impl_._has_bits_[0] |= 0x00000001u;
...
inline ::city::person::v2::Person* PersonRuntime::mutable_base() {
  ::city::person::v2::Person* _msg = _internal_mutable_base();
  // @@protoc_insertion_point(field_mutable:city.person.v2.PersonRuntime.base)
  return _msg;
}
inline void PersonRuntime::set_allocated_base(::city::person::v2::Person* base) {
  ...
  _impl_.base_ = base;
  // @@protoc_insertion_point(field_set_allocated:city.person.v2.PersonRuntime.base)
}
...
inline const ::city::person::v2::PersonMotion& PersonRuntime::_internal_motion() const {
...
inline const ::city::person::v2::PersonMotion& PersonRuntime::motion() const {
  // @@protoc_insertion_point(field_get:city.person.v2.PersonRuntime.motion)
...
inline void PersonRuntime::unsafe_arena_set_allocated_motion(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:city.person.v2.PersonRuntime.motion)
}
inline ::city::person::v2::PersonMotion* PersonRuntime::release_motion() {
...
inline ::city::person::v2::PersonMotion* PersonRuntime::unsafe_arena_release_motion() {
  // @@protoc_insertion_point(field_release:city.person.v2.PersonRuntime.motion)
  
  ::city::person::v2::PersonMotion* temp = _impl_.motion_;
  _impl_.motion_ = nullptr;
  return temp;
}
inline ::city::person::v2::PersonMotion* PersonRuntime::_internal_mutable_motion() {
...
inline ::city::person::v2::PersonMotion* PersonRuntime::mutable_motion() {
  ::city::person::v2::PersonMotion* _msg = _internal_mutable_motion();
  // @@protoc_insertion_point(field_mutable:city.person.v2.PersonRuntime.motion)
  return _msg;
}
inline void PersonRuntime::set_allocated_motion(::city::person::v2::PersonMotion* motion) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.motion_);
  }
  ...
  _impl_.motion_ = motion;
  // @@protoc_insertion_point(field_set_allocated:city.person.v2.PersonRuntime.motion)
}
...
inline ::city::event::v2::Event* PersonRuntime::mutable_events(int index) {
  // @@protoc_insertion_point(field_mutable:city.person.v2.PersonRuntime.events)
...
PersonRuntime::mutable_events() {
  // @@protoc_insertion_point(field_mutable_list:city.person.v2.PersonRuntime.events)
...
inline const ::city::event::v2::Event& PersonRuntime::events(int index) const {
  // @@protoc_insertion_point(field_get:city.person.v2.PersonRuntime.events)
...
inline ::city::event::v2::Event* PersonRuntime::add_events() {
  ...
  // @@protoc_insertion_point(field_add:city.person.v2.PersonRuntime.events)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::city::event::v2::Event >&
PersonRuntime::events() const {
  // @@protoc_insertion_point(field_list:city.person.v2.PersonRuntime.events)
  return _impl_.events_;
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_city_2fperson_2fv2_2fperson_5fruntime_2eproto
