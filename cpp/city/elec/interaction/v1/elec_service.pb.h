...
#ifndef GOOGLE_PROTOBUF_INCLUDED_city_2felec_2finteraction_2fv1_2felec_5fservice_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_city_2felec_2finteraction_2fv1_2felec_5fservice_2eproto_2epb_2eh
...
extern const ::google::protobuf::internal::DescriptorTable
    descriptor_table_city_2felec_2finteraction_2fv1_2felec_5fservice_2eproto;
namespace city {
namespace elec {
...
class SetStatusRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:city.elec.interaction.v1.SetStatusRequest) */ {
 public:
  inline SetStatusRequest() : SetStatusRequest(nullptr) {}
  ~SetStatusRequest() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR SetStatusRequest(::google::protobuf::internal::ConstantInitialized);
  ...
  SetStatusRequest* New(::google::protobuf::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit SetStatusRequest(::google::protobuf::Arena* arena);
  public:
...
class SetStatusResponse final :
    public ::google::protobuf::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:city.elec.interaction.v1.SetStatusResponse) */ {
 public:
  inline SetStatusResponse() : SetStatusResponse(nullptr) {}
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR SetStatusResponse(::google::protobuf::internal::ConstantInitialized);
  ...
  SetStatusResponse* New(::google::protobuf::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit SetStatusResponse(::google::protobuf::Arena* arena);
  public:
...
class GetPowerRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:city.elec.interaction.v1.GetPowerRequest) */ {
 public:
...
class GetPowerResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:city.elec.interaction.v1.GetPowerResponse) */ {
 public:
...
class GetPowerStatusRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:city.elec.interaction.v1.GetPowerStatusRequest) */ {
 public:
  inline GetPowerStatusRequest() : GetPowerStatusRequest(nullptr) {}
  ~GetPowerStatusRequest() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR GetPowerStatusRequest(::google::protobuf::internal::ConstantInitialized);
  ...
  GetPowerStatusRequest* New(::google::protobuf::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit GetPowerStatusRequest(::google::protobuf::Arena* arena);
  public:
...
class GetPowerStatusResponse_PowerStatusEntry_DoNotUse final : public ::google::protobuf::internal::MapEntry<GetPowerStatusResponse_PowerStatusEntry_DoNotUse, 
    ::int32_t, double,
    ::google::protobuf::internal::WireFormatLite::TYPE_INT32,
    ::google::protobuf::internal::WireFormatLite::TYPE_DOUBLE> {
public:
  typedef ::google::protobuf::internal::MapEntry<GetPowerStatusResponse_PowerStatusEntry_DoNotUse, 
    ::int32_t, double,
    ::google::protobuf::internal::WireFormatLite::TYPE_INT32,
  ...
  explicit GetPowerStatusResponse_PowerStatusEntry_DoNotUse(::google::protobuf::Arena* arena);
...
class GetPowerStatusResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:city.elec.interaction.v1.GetPowerStatusResponse) */ {
 public:
  inline GetPowerStatusResponse() : GetPowerStatusResponse(nullptr) {}
  ~GetPowerStatusResponse() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR GetPowerStatusResponse(::google::protobuf::internal::ConstantInitialized);
  ...
  GetPowerStatusResponse* New(::google::protobuf::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit GetPowerStatusResponse(::google::protobuf::Arena* arena);
  public:
  ...
  const ::google::protobuf::Map<::int32_t, double>& power_status() const;
  ::google::protobuf::Map<::int32_t, double>* mutable_power_status();

  private:
  const ::google::protobuf::Map<::int32_t, double>& _internal_power_status() const;
  ::google::protobuf::Map<::int32_t, double>* _internal_mutable_power_status();
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::google::protobuf::internal::MapField<GetPowerStatusResponse_PowerStatusEntry_DoNotUse, ::int32_t, double,
                      ::google::protobuf::internal::WireFormatLite::TYPE_INT32,
                      ::google::protobuf::internal::WireFormatLite::TYPE_DOUBLE>
        power_status_;
    mutable ::google::protobuf::internal::CachedSize _cached_size_;
...
class GetNoPowerAOIRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:city.elec.interaction.v1.GetNoPowerAOIRequest) */ {
 public:
  inline GetNoPowerAOIRequest() : GetNoPowerAOIRequest(nullptr) {}
  ~GetNoPowerAOIRequest() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR GetNoPowerAOIRequest(::google::protobuf::internal::ConstantInitialized);
  ...
  GetNoPowerAOIRequest* New(::google::protobuf::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit GetNoPowerAOIRequest(::google::protobuf::Arena* arena);
  public:
...
class GetNoPowerAOIResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:city.elec.interaction.v1.GetNoPowerAOIResponse) */ {
 public:
  inline GetNoPowerAOIResponse() : GetNoPowerAOIResponse(nullptr) {}
  ~GetNoPowerAOIResponse() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR GetNoPowerAOIResponse(::google::protobuf::internal::ConstantInitialized);
  ...
  GetNoPowerAOIResponse* New(::google::protobuf::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit GetNoPowerAOIResponse(::google::protobuf::Arena* arena);
  public:
...
class GetRuinInfoRequest final :
    public ::google::protobuf::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:city.elec.interaction.v1.GetRuinInfoRequest) */ {
 public:
...
class RuinInfo final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:city.elec.interaction.v1.RuinInfo) */ {
 public:
...
class GetRuinInfoResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:city.elec.interaction.v1.GetRuinInfoResponse) */ {
 public:
  ...
  void set_allocated_one(::city::elec::interaction::v1::RuinInfo* value);
  void unsafe_arena_set_allocated_one(::city::elec::interaction::v1::RuinInfo* value);
  ...
  void set_allocated_two(::city::elec::interaction::v1::RuinInfo* value);
  void unsafe_arena_set_allocated_two(::city::elec::interaction::v1::RuinInfo* value);
  ...
  void set_allocated_three(::city::elec::interaction::v1::RuinInfo* value);
  void unsafe_arena_set_allocated_three(::city::elec::interaction::v1::RuinInfo* value);
...
class GetEdgeStatusRequest final :
    public ::google::protobuf::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:city.elec.interaction.v1.GetEdgeStatusRequest) */ {
 public:
  inline GetEdgeStatusRequest() : GetEdgeStatusRequest(nullptr) {}
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR GetEdgeStatusRequest(::google::protobuf::internal::ConstantInitialized);
  ...
  GetEdgeStatusRequest* New(::google::protobuf::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit GetEdgeStatusRequest(::google::protobuf::Arena* arena);
  public:
...
class GetEdgeStatusResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:city.elec.interaction.v1.GetEdgeStatusResponse) */ {
 public:
  inline GetEdgeStatusResponse() : GetEdgeStatusResponse(nullptr) {}
  ~GetEdgeStatusResponse() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR GetEdgeStatusResponse(::google::protobuf::internal::ConstantInitialized);
  ...
  GetEdgeStatusResponse* New(::google::protobuf::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit GetEdgeStatusResponse(::google::protobuf::Arena* arena);
  public:
  ...
  void set_reason1(int index, const char* value, std::size_t size);
  void set_reason1(int index, absl::string_view value);
  ...
  void add_reason1(const char* value, std::size_t size);
  void add_reason1(absl::string_view value);
  const ::google::protobuf::RepeatedPtrField<std::string>& reason1() const;
  ::google::protobuf::RepeatedPtrField<std::string>* mutable_reason1();

  private:
  const ::google::protobuf::RepeatedPtrField<std::string>& _internal_reason1() const;
  ::google::protobuf::RepeatedPtrField<std::string>* _internal_mutable_reason1();
  ...
  void set_reason2(int index, const char* value, std::size_t size);
  void set_reason2(int index, absl::string_view value);
  ...
  void add_reason2(const char* value, std::size_t size);
  void add_reason2(absl::string_view value);
  const ::google::protobuf::RepeatedPtrField<std::string>& reason2() const;
  ::google::protobuf::RepeatedPtrField<std::string>* mutable_reason2();

  private:
  const ::google::protobuf::RepeatedPtrField<std::string>& _internal_reason2() const;
  ::google::protobuf::RepeatedPtrField<std::string>* _internal_mutable_reason2();
  ...
  void set_reason3(int index, const char* value, std::size_t size);
  void set_reason3(int index, absl::string_view value);
  ...
  void add_reason3(const char* value, std::size_t size);
  void add_reason3(absl::string_view value);
  const ::google::protobuf::RepeatedPtrField<std::string>& reason3() const;
  ::google::protobuf::RepeatedPtrField<std::string>* mutable_reason3();

  private:
  const ::google::protobuf::RepeatedPtrField<std::string>& _internal_reason3() const;
  ::google::protobuf::RepeatedPtrField<std::string>* _internal_mutable_reason3();
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::google::protobuf::RepeatedPtrField<std::string> reason1_;
    ::google::protobuf::RepeatedPtrField<std::string> reason2_;
    ::google::protobuf::RepeatedPtrField<std::string> reason3_;
    mutable ::google::protobuf::internal::CachedSize _cached_size_;
    PROTOBUF_TSAN_DECLARE_MEMBER
  };
  union { Impl_ _impl_; };
...
inline int GetPowerStatusResponse::_internal_power_status_size() const {
  return _internal_power_status().size();
}
...
inline const ::google::protobuf::Map<::int32_t, double>& GetPowerStatusResponse::_internal_power_status() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.power_status_.GetMap();
}
inline const ::google::protobuf::Map<::int32_t, double>& GetPowerStatusResponse::power_status() const {
...
inline ::google::protobuf::Map<::int32_t, double>* GetPowerStatusResponse::_internal_mutable_power_status() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  return _impl_.power_status_.MutableMap();
}
inline ::google::protobuf::Map<::int32_t, double>* GetPowerStatusResponse::mutable_power_status() {
...
inline const ::google::protobuf::RepeatedField<::int32_t>& GetNoPowerAOIResponse::aoi() const {
  // @@protoc_insertion_point(field_list:city.elec.interaction.v1.GetNoPowerAOIResponse.aoi)
  return _internal_aoi();
}
inline ::google::protobuf::RepeatedField<::int32_t>* GetNoPowerAOIResponse::mutable_aoi() {
  // @@protoc_insertion_point(field_mutable_list:city.elec.interaction.v1.GetNoPowerAOIResponse.aoi)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  return _internal_mutable_aoi();
}

inline const ::google::protobuf::RepeatedField<::int32_t>& GetNoPowerAOIResponse::_internal_aoi() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.aoi_;
}
inline ::google::protobuf::RepeatedField<::int32_t>* GetNoPowerAOIResponse::_internal_mutable_aoi() {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return &_impl_.aoi_;
}
...
inline const ::city::elec::interaction::v1::RuinInfo& GetRuinInfoResponse::_internal_one() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::city::elec::interaction::v1::RuinInfo&>(::city::elec::interaction::v1::_RuinInfo_default_instance_);
}
...
inline void GetRuinInfoResponse::unsafe_arena_set_allocated_one(::city::elec::interaction::v1::RuinInfo* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.one_);
  }
  _impl_.one_ = reinterpret_cast<::city::elec::interaction::v1::RuinInfo*>(value);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
...
inline ::city::elec::interaction::v1::RuinInfo* GetRuinInfoResponse::release_one() {
  ...
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::city::elec::interaction::v1::RuinInfo* released = _impl_.one_;
  _impl_.one_ = nullptr;
...
inline ::city::elec::interaction::v1::RuinInfo* GetRuinInfoResponse::_internal_mutable_one() {
  ...
  if (_impl_.one_ == nullptr) {
    ...
    _impl_.one_ = reinterpret_cast<::city::elec::interaction::v1::RuinInfo*>(p);
  }
  return _impl_.one_;
}
...
inline void GetRuinInfoResponse::set_allocated_one(::city::elec::interaction::v1::RuinInfo* value) {
  ::google::protobuf::Arena* message_arena = GetArenaForAllocation();
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::city::elec::interaction::v1::RuinInfo*>(_impl_.one_);
  }

  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena =
        ::google::protobuf::Arena::InternalGetOwningArena(reinterpret_cast<::city::elec::interaction::v1::RuinInfo*>(value));
...
inline void GetRuinInfoResponse::unsafe_arena_set_allocated_two(::city::elec::interaction::v1::RuinInfo* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.two_);
  }
  _impl_.two_ = reinterpret_cast<::city::elec::interaction::v1::RuinInfo*>(value);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000002u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000002u;
...
inline ::city::elec::interaction::v1::RuinInfo* GetRuinInfoResponse::release_two() {
  ...
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::city::elec::interaction::v1::RuinInfo* released = _impl_.two_;
  _impl_.two_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old = reinterpret_cast<::google::protobuf::MessageLite*>(released);
  released = ::google::protobuf::internal::DuplicateIfNonNull(released);
...
inline ::city::elec::interaction::v1::RuinInfo* GetRuinInfoResponse::_internal_mutable_two() {
  ...
  if (_impl_.two_ == nullptr) {
    auto* p = CreateMaybeMessage<::city::elec::interaction::v1::RuinInfo>(GetArenaForAllocation());
    _impl_.two_ = reinterpret_cast<::city::elec::interaction::v1::RuinInfo*>(p);
  }
  return _impl_.two_;
}
...
inline void GetRuinInfoResponse::set_allocated_two(::city::elec::interaction::v1::RuinInfo* value) {
  ::google::protobuf::Arena* message_arena = GetArenaForAllocation();
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::city::elec::interaction::v1::RuinInfo*>(_impl_.two_);
  }
...
inline void GetRuinInfoResponse::unsafe_arena_set_allocated_three(::city::elec::interaction::v1::RuinInfo* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.three_);
  }
  _impl_.three_ = reinterpret_cast<::city::elec::interaction::v1::RuinInfo*>(value);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000004u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000004u;
...
inline ::city::elec::interaction::v1::RuinInfo* GetRuinInfoResponse::release_three() {
  ...
  _impl_._has_bits_[0] &= ~0x00000004u;
  ::city::elec::interaction::v1::RuinInfo* released = _impl_.three_;
...
inline ::city::elec::interaction::v1::RuinInfo* GetRuinInfoResponse::_internal_mutable_three() {
  ...
  if (_impl_.three_ == nullptr) {
    auto* p = CreateMaybeMessage<::city::elec::interaction::v1::RuinInfo>(GetArenaForAllocation());
    _impl_.three_ = reinterpret_cast<::city::elec::interaction::v1::RuinInfo*>(p);
  }
...
inline void GetRuinInfoResponse::set_allocated_three(::city::elec::interaction::v1::RuinInfo* value) {
  ::google::protobuf::Arena* message_arena = GetArenaForAllocation();
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::city::elec::interaction::v1::RuinInfo*>(_impl_.three_);
  }
...
inline std::string* GetEdgeStatusResponse::add_reason1() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  std::string* _s = _internal_mutable_reason1()->Add();
...
inline const std::string& GetEdgeStatusResponse::reason1(int index) const {
  ...
  return _internal_reason1().Get(index);
}
inline std::string* GetEdgeStatusResponse::mutable_reason1(int index) {
  ...
  return _internal_mutable_reason1()->Mutable(index);
}
inline void GetEdgeStatusResponse::set_reason1(int index, const std::string& value) {
  _internal_mutable_reason1()->Mutable(index)->assign(value);
...
inline void GetEdgeStatusResponse::set_reason1(int index, std::string&& value) {
  _internal_mutable_reason1()->Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:city.elec.interaction.v1.GetEdgeStatusResponse.reason1)
}
...
inline void GetEdgeStatusResponse::set_reason1(int index, const char* value,
                              std::size_t size) {
  _internal_mutable_reason1()->Mutable(index)->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:city.elec.interaction.v1.GetEdgeStatusResponse.reason1)
}
inline void GetEdgeStatusResponse::set_reason1(int index, absl::string_view value) {
  _internal_mutable_reason1()->Mutable(index)->assign(value.data(),
                                                     value.size());
  // @@protoc_insertion_point(field_set_string_piece:city.elec.interaction.v1.GetEdgeStatusResponse.reason1)
}
inline void GetEdgeStatusResponse::add_reason1(const std::string& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_reason1()->Add()->assign(value);
...
inline void GetEdgeStatusResponse::add_reason1(std::string&& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_reason1()->Add(std::move(value));
  // @@protoc_insertion_point(field_add:city.elec.interaction.v1.GetEdgeStatusResponse.reason1)
}
...
inline void GetEdgeStatusResponse::add_reason1(const char* value, std::size_t size) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_reason1()->Add()->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:city.elec.interaction.v1.GetEdgeStatusResponse.reason1)
}
inline void GetEdgeStatusResponse::add_reason1(absl::string_view value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_reason1()->Add()->assign(value.data(), value.size());
  // @@protoc_insertion_point(field_add_string_piece:city.elec.interaction.v1.GetEdgeStatusResponse.reason1)
}
...
GetEdgeStatusResponse::reason1() const {
  ...
  return _internal_reason1();
}
inline ::google::protobuf::RepeatedPtrField<std::string>* GetEdgeStatusResponse::mutable_reason1() {
  // @@protoc_insertion_point(field_mutable_list:city.elec.interaction.v1.GetEdgeStatusResponse.reason1)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  return _internal_mutable_reason1();
}
inline const ::google::protobuf::RepeatedPtrField<std::string>&
GetEdgeStatusResponse::_internal_reason1() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.reason1_;
}
inline ::google::protobuf::RepeatedPtrField<std::string>*
GetEdgeStatusResponse::_internal_mutable_reason1() {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return &_impl_.reason1_;
}
...
inline std::string* GetEdgeStatusResponse::add_reason2() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  std::string* _s = _internal_mutable_reason2()->Add();
...
inline const std::string& GetEdgeStatusResponse::reason2(int index) const {
  ...
  return _internal_reason2().Get(index);
}
inline std::string* GetEdgeStatusResponse::mutable_reason2(int index) {
  ...
  return _internal_mutable_reason2()->Mutable(index);
}
inline void GetEdgeStatusResponse::set_reason2(int index, const std::string& value) {
  _internal_mutable_reason2()->Mutable(index)->assign(value);
...
inline void GetEdgeStatusResponse::set_reason2(int index, std::string&& value) {
  _internal_mutable_reason2()->Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:city.elec.interaction.v1.GetEdgeStatusResponse.reason2)
}
...
inline void GetEdgeStatusResponse::set_reason2(int index, const char* value,
                              std::size_t size) {
  _internal_mutable_reason2()->Mutable(index)->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:city.elec.interaction.v1.GetEdgeStatusResponse.reason2)
}
inline void GetEdgeStatusResponse::set_reason2(int index, absl::string_view value) {
  _internal_mutable_reason2()->Mutable(index)->assign(value.data(),
                                                     value.size());
  // @@protoc_insertion_point(field_set_string_piece:city.elec.interaction.v1.GetEdgeStatusResponse.reason2)
}
inline void GetEdgeStatusResponse::add_reason2(const std::string& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_reason2()->Add()->assign(value);
...
inline void GetEdgeStatusResponse::add_reason2(std::string&& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_reason2()->Add(std::move(value));
  // @@protoc_insertion_point(field_add:city.elec.interaction.v1.GetEdgeStatusResponse.reason2)
}
...
inline void GetEdgeStatusResponse::add_reason2(const char* value, std::size_t size) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_reason2()->Add()->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:city.elec.interaction.v1.GetEdgeStatusResponse.reason2)
}
inline void GetEdgeStatusResponse::add_reason2(absl::string_view value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_reason2()->Add()->assign(value.data(), value.size());
  // @@protoc_insertion_point(field_add_string_piece:city.elec.interaction.v1.GetEdgeStatusResponse.reason2)
}
inline const ::google::protobuf::RepeatedPtrField<std::string>&
GetEdgeStatusResponse::reason2() const {
  ...
  return _internal_reason2();
}
inline ::google::protobuf::RepeatedPtrField<std::string>* GetEdgeStatusResponse::mutable_reason2() {
  // @@protoc_insertion_point(field_mutable_list:city.elec.interaction.v1.GetEdgeStatusResponse.reason2)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  return _internal_mutable_reason2();
}
inline const ::google::protobuf::RepeatedPtrField<std::string>&
GetEdgeStatusResponse::_internal_reason2() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.reason2_;
}
inline ::google::protobuf::RepeatedPtrField<std::string>*
GetEdgeStatusResponse::_internal_mutable_reason2() {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return &_impl_.reason2_;
}
...
inline std::string* GetEdgeStatusResponse::add_reason3() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  std::string* _s = _internal_mutable_reason3()->Add();
...
inline const std::string& GetEdgeStatusResponse::reason3(int index) const {
  ...
  return _internal_reason3().Get(index);
}
inline std::string* GetEdgeStatusResponse::mutable_reason3(int index) {
  ...
  return _internal_mutable_reason3()->Mutable(index);
}
inline void GetEdgeStatusResponse::set_reason3(int index, const std::string& value) {
  _internal_mutable_reason3()->Mutable(index)->assign(value);
...
inline void GetEdgeStatusResponse::set_reason3(int index, std::string&& value) {
  _internal_mutable_reason3()->Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:city.elec.interaction.v1.GetEdgeStatusResponse.reason3)
}
...
inline void GetEdgeStatusResponse::set_reason3(int index, const char* value,
                              std::size_t size) {
  _internal_mutable_reason3()->Mutable(index)->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:city.elec.interaction.v1.GetEdgeStatusResponse.reason3)
}
inline void GetEdgeStatusResponse::set_reason3(int index, absl::string_view value) {
  _internal_mutable_reason3()->Mutable(index)->assign(value.data(),
                                                     value.size());
  // @@protoc_insertion_point(field_set_string_piece:city.elec.interaction.v1.GetEdgeStatusResponse.reason3)
}
inline void GetEdgeStatusResponse::add_reason3(const std::string& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_reason3()->Add()->assign(value);
...
inline void GetEdgeStatusResponse::add_reason3(std::string&& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_reason3()->Add(std::move(value));
  // @@protoc_insertion_point(field_add:city.elec.interaction.v1.GetEdgeStatusResponse.reason3)
}
...
inline void GetEdgeStatusResponse::add_reason3(const char* value, std::size_t size) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_reason3()->Add()->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:city.elec.interaction.v1.GetEdgeStatusResponse.reason3)
}
inline void GetEdgeStatusResponse::add_reason3(absl::string_view value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_reason3()->Add()->assign(value.data(), value.size());
  // @@protoc_insertion_point(field_add_string_piece:city.elec.interaction.v1.GetEdgeStatusResponse.reason3)
}
inline const ::google::protobuf::RepeatedPtrField<std::string>&
GetEdgeStatusResponse::reason3() const {
  ...
  return _internal_reason3();
}
inline ::google::protobuf::RepeatedPtrField<std::string>* GetEdgeStatusResponse::mutable_reason3() {
  // @@protoc_insertion_point(field_mutable_list:city.elec.interaction.v1.GetEdgeStatusResponse.reason3)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  return _internal_mutable_reason3();
}
inline const ::google::protobuf::RepeatedPtrField<std::string>&
GetEdgeStatusResponse::_internal_reason3() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.reason3_;
}
inline ::google::protobuf::RepeatedPtrField<std::string>*
GetEdgeStatusResponse::_internal_mutable_reason3() {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return &_impl_.reason3_;
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_city_2felec_2finteraction_2fv1_2felec_5fservice_2eproto_2epb_2eh
