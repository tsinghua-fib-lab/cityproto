...
#ifndef GOOGLE_PROTOBUF_INCLUDED_city_2felec_2finput_2fv1_2finput_5fservice_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_city_2felec_2finput_2fv1_2finput_5fservice_2eproto_2epb_2eh
...
extern const ::google::protobuf::internal::DescriptorTable
    descriptor_table_city_2felec_2finput_2fv1_2finput_5fservice_2eproto;
namespace city {
namespace elec {
namespace input {
namespace v1 {
...
class InitRequest final :
    public ::google::protobuf::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:city.elec.input.v1.InitRequest) */ {
 public:
...
class InitResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:city.elec.input.v1.InitResponse) */ {
 public:
  ...
  void set_allocated_facilities(::city::elec::input::v1::Facilities* value);
  void unsafe_arena_set_allocated_facilities(::city::elec::input::v1::Facilities* value);
 ...
 private:
  ...
  static const ::google::protobuf::internal::TcParseTable<2, 4, 3, 47, 2> _table_;
  template <typename T> friend class ::google::protobuf::Arena::InternalHelper;
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  struct Impl_ {
...
inline void InitResponse::unsafe_arena_set_allocated_control(::city::elec::input::v1::Control* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
...
inline void InitResponse::set_allocated_control(::city::elec::input::v1::Control* value) {
...
inline const ::city::elec::input::v1::Facilities& InitResponse::_internal_facilities() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::city::elec::input::v1::Facilities&>(::city::elec::input::v1::_Facilities_default_instance_);
}
...
inline void InitResponse::unsafe_arena_set_allocated_facilities(::city::elec::input::v1::Facilities* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.facilities_);
  }
  _impl_.facilities_ = reinterpret_cast<::city::elec::input::v1::Facilities*>(value);
  if (value != nullptr) {
...
inline ::city::elec::input::v1::Facilities* InitResponse::release_facilities() {
  ...
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::city::elec::input::v1::Facilities* released = _impl_.facilities_;
...
inline ::city::elec::input::v1::Facilities* InitResponse::_internal_mutable_facilities() {
  ...
  if (_impl_.facilities_ == nullptr) {
    ...
    _impl_.facilities_ = reinterpret_cast<::city::elec::input::v1::Facilities*>(p);
  }
...
inline void InitResponse::set_allocated_facilities(::city::elec::input::v1::Facilities* value) {
  ::google::protobuf::Arena* message_arena = GetArenaForAllocation();
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.facilities_);
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_city_2felec_2finput_2fv1_2finput_5fservice_2eproto_2epb_2eh
