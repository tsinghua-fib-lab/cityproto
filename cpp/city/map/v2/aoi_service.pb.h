...
inline ::city::person::v2::PersonMotion* AoiState::mutable_persons(int index) {
...
inline const ::city::person::v2::PersonMotion& AoiState::_internal_persons(int index) const {
  return _impl_.persons_.Get(index);
}
inline const ::city::person::v2::PersonMotion& AoiState::persons(int index) const {
  // @@protoc_insertion_point(field_get:city.map.v2.AoiState.persons)
  return _internal_persons(index);
}
inline ::city::person::v2::PersonMotion* AoiState::_internal_add_persons() {
  return _impl_.persons_.Add();
}
inline ::city::person::v2::PersonMotion* AoiState::add_persons() {
