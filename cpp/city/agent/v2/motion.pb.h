...
#ifndef GOOGLE_PROTOBUF_INCLUDED_city_2fagent_2fv2_2fmotion_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_city_2fagent_2fv2_2fmotion_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_city_2fagent_2fv2_2fmotion_2eproto;
namespace city {
namespace agent {
namespace v2 {
class AgentMotion;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::city::agent::v2::AgentMotion* Arena::CreateMaybeMessage<::city::agent::v2::AgentMotion>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace city {
namespace agent {
namespace v2 {
...
class AgentMotion final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:city.agent.v2.AgentMotion) */ {
 public:
  inline AgentMotion() : AgentMotion(nullptr) {}
  ~AgentMotion() override;
  explicit PROTOBUF_CONSTEXPR AgentMotion(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  AgentMotion* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit AgentMotion(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
// .city.geo.v2.Position position = 3 [json_name = "position"];
inline bool AgentMotion::_internal_has_position() const {
...
inline void AgentMotion::unsafe_arena_set_allocated_position(
    ::city::geo::v2::Position* position) {
...
inline void AgentMotion::set_allocated_position(::city::geo::v2::Position* position) {
...
void AgentMotion::set_activity(ArgT0&& arg0, ArgT... args) {
...
inline void AgentMotion::set_allocated_activity(std::string* activity) {
  if (activity != nullptr) {
...
template <> struct is_proto_enum< ::city::agent::v2::Status> : ::std::true_type {};
template <>
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_city_2fagent_2fv2_2fmotion_2eproto
