...
class Mongo(_message.Message):
    ...
    agents: _config_pb2.MongoPath
    edges: _config_pb2.MongoPath

    def __init__(self, uri: _Optional[str]=..., map: _Optional[_Union[_config_pb2.MongoPath, _Mapping]]=..., agents: _Optional[_Union[_config_pb2.MongoPath, _Mapping]]=..., edges: _Optional[_Union[_config_pb2.MongoPath, _Mapping]]=...) -> None:
        ...
...
class OutputSwitch(_message.Message):
    ...
    def __init__(self, common: bool=...) -> None:
        ...
