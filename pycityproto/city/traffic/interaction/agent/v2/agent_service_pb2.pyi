...
from city.traffic.interaction.agent.v2 import agent_pb2 as _agent_pb2_1
...
class GetAgentResponse(_message.Message):
    ...
    runtime: _agent_pb2_1.AgentRuntime

    def __init__(self, base: _Optional[_Union[_agent_pb2.Agent, _Mapping]]=..., runtime: _Optional[_Union[_agent_pb2_1.AgentRuntime, _Mapping]]=...) -> None:
        ...
...
class GetAgentsByLongLatAreaResponse(_message.Message):
    ...
    step: int
    agents: _containers.RepeatedCompositeFieldContainer[_agent_pb2_1.AgentRuntime]

    def __init__(self, step: _Optional[int]=..., agents: _Optional[_Iterable[_Union[_agent_pb2_1.AgentRuntime, _Mapping]]]=...) -> None:
        ...