...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_ENTITYTYPE']._serialized_start = 329
    _globals['_ENTITYTYPE']._serialized_end = 527
    _globals['_ENTITY']._serialized_start = 67
    _globals['_ENTITY']._serialized_end = 138
    _globals['_EVENT']._serialized_start = 141
    _globals['_EVENT']._serialized_end = 326