...
class OrgServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetDepressionStatus = channel.unary_unary('/city.economy.v2.OrgService/GetDepressionStatus', request_serializer=city_dot_economy_dot_v2_dot_org__service__pb2.GetDepressionStatusRequest.SerializeToString, response_deserializer=city_dot_economy_dot_v2_dot_org__service__pb2.GetDepressionStatusResponse.FromString)
        self.SetDepressionStatus = channel.unary_unary('/city.economy.v2.OrgService/SetDepressionStatus', request_serializer=city_dot_economy_dot_v2_dot_org__service__pb2.SetDepressionStatusRequest.SerializeToString, response_deserializer=city_dot_economy_dot_v2_dot_org__service__pb2.SetDepressionStatusResponse.FromString)
...
class OrgServiceServicer(object):
    ...
    def GetDepressionStatus(self, request, context):
        """Depression
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
    ...
    def SetDepressionStatus(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
class OrgService(object):
    ...
    @staticmethod
    def GetDepressionStatus(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/city.economy.v2.OrgService/GetDepressionStatus', city_dot_economy_dot_v2_dot_org__service__pb2.GetDepressionStatusRequest.SerializeToString, city_dot_economy_dot_v2_dot_org__service__pb2.GetDepressionStatusResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def SetDepressionStatus(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/city.economy.v2.OrgService/SetDepressionStatus', city_dot_economy_dot_v2_dot_org__service__pb2.SetDepressionStatusRequest.SerializeToString, city_dot_economy_dot_v2_dot_org__service__pb2.SetDepressionStatusResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
