...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_TRIPMODE']._serialized_start = 651
    _globals['_TRIPMODE']._serialized_end = 788
    _globals['_TRIP']._serialized_start = 96
    _globals['_TRIP']._serialized_end = 451
    _globals['_SCHEDULE']._serialized_start = 454
    _globals['_SCHEDULE']._serialized_end = 648