...
class RoadServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetRoadGlobalStatistics = channel.unary_unary('/city.map.v2.RoadService/GetRoadGlobalStatistics', request_serializer=city_dot_map_dot_v2_dot_road__service__pb2.GetRoadGlobalStatisticsRequest.SerializeToString, response_deserializer=city_dot_map_dot_v2_dot_road__service__pb2.GetRoadGlobalStatisticsResponse.FromString)
...
class RoadServiceServicer(object):
    ...
    def GetRoadGlobalStatistics(self, request, context):
        """获取全局统计信息
...
def add_RoadServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {'GetRoad': grpc.unary_unary_rpc_method_handler(servicer.GetRoad, request_deserializer=city_dot_map_dot_v2_dot_road__service__pb2.GetRoadRequest.FromString, response_serializer=city_dot_map_dot_v2_dot_road__service__pb2.GetRoadResponse.SerializeToString), 'GetRoadGlobalStatistics': grpc.unary_unary_rpc_method_handler(servicer.GetRoadGlobalStatistics, request_deserializer=city_dot_map_dot_v2_dot_road__service__pb2.GetRoadGlobalStatisticsRequest.FromString, response_serializer=city_dot_map_dot_v2_dot_road__service__pb2.GetRoadGlobalStatisticsResponse.SerializeToString), 'GetRuinInfo': grpc.unary_unary_rpc_method_handler(servicer.GetRuinInfo, request_deserializer=city_dot_map_dot_v2_dot_road__service__pb2.GetRuinInfoRequest.FromString, response_serializer=city_dot_map_dot_v2_dot_road__service__pb2.GetRuinInfoResponse.SerializeToString), 'GetEvents': grpc.unary_unary_rpc_method_handler(servicer.GetEvents, request_deserializer=city_dot_map_dot_v2_dot_road__service__pb2.GetEventsRequest.FromString, response_serializer=city_dot_map_dot_v2_dot_road__service__pb2.GetEventsResponse.SerializeToString)}
...
class RoadService(object):
    ...
    @staticmethod
    def GetRoadGlobalStatistics(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/city.map.v2.RoadService/GetRoadGlobalStatistics', city_dot_map_dot_v2_dot_road__service__pb2.GetRoadGlobalStatisticsRequest.SerializeToString, city_dot_map_dot_v2_dot_road__service__pb2.GetRoadGlobalStatisticsResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
