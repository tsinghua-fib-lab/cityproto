...
class RoadServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetRoadByLongLatBBox = channel.unary_unary('/city.map.v2.RoadService/GetRoadByLongLatBBox', request_serializer=city_dot_map_dot_v2_dot_road__service__pb2.GetRoadByLongLatBBoxRequest.SerializeToString, response_deserializer=city_dot_map_dot_v2_dot_road__service__pb2.GetRoadByLongLatBBoxResponse.FromString)
...
class RoadServiceServicer(object):
    ...
    def GetRoadByLongLatBBox(self, request, context):
        """查询特定区域内的道路信息
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
...
def add_RoadServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {'GetRoad': grpc.unary_unary_rpc_method_handler(servicer.GetRoad, request_deserializer=city_dot_map_dot_v2_dot_road__service__pb2.GetRoadRequest.FromString, response_serializer=city_dot_map_dot_v2_dot_road__service__pb2.GetRoadResponse.SerializeToString), 'GetRoadByLongLatBBox': grpc.unary_unary_rpc_method_handler(servicer.GetRoadByLongLatBBox, request_deserializer=city_dot_map_dot_v2_dot_road__service__pb2.GetRoadByLongLatBBoxRequest.FromString, response_serializer=city_dot_map_dot_v2_dot_road__service__pb2.GetRoadByLongLatBBoxResponse.SerializeToString), 'GetRuinInfo': grpc.unary_unary_rpc_method_handler(servicer.GetRuinInfo, request_deserializer=city_dot_map_dot_v2_dot_road__service__pb2.GetRuinInfoRequest.FromString, response_serializer=city_dot_map_dot_v2_dot_road__service__pb2.GetRuinInfoResponse.SerializeToString), 'GetEvents': grpc.unary_unary_rpc_method_handler(servicer.GetEvents, request_deserializer=city_dot_map_dot_v2_dot_road__service__pb2.GetEventsRequest.FromString, response_serializer=city_dot_map_dot_v2_dot_road__service__pb2.GetEventsResponse.SerializeToString)}
...
class RoadService(object):
    ...
    @staticmethod
    def GetRoadByLongLatBBox(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/city.map.v2.RoadService/GetRoadByLongLatBBox', city_dot_map_dot_v2_dot_road__service__pb2.GetRoadByLongLatBBoxRequest.SerializeToString, city_dot_map_dot_v2_dot_road__service__pb2.GetRoadByLongLatBBoxResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
