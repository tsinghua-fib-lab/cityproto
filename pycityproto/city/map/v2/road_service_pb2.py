...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_ROADLEVEL']._serialized_start = 732
    _globals['_ROADLEVEL']._serialized_end = 927
    _globals['_INTERRUPTIONREASON']._serialized_start = 930
    _globals['_INTERRUPTIONREASON']._serialized_end = 1088
    _globals['_GETROADREQUEST']._serialized_start = 106
    _globals['_GETROADREQUEST']._serialized_end = 149
    _globals['_GETROADRESPONSE']._serialized_start = 151
    _globals['_GETROADRESPONSE']._serialized_end = 216
    _globals['_GETRUININFOREQUEST']._serialized_start = 218
    _globals['_GETRUININFOREQUEST']._serialized_end = 238
    _globals['_RUININFO']._serialized_start = 240
    _globals['_RUININFO']._serialized_end = 290
    _globals['_GETRUININFORESPONSE']._serialized_start = 293
    _globals['_GETRUININFORESPONSE']._serialized_end = 441
    _globals['_GETEVENTSREQUEST']._serialized_start = 443
    _globals['_GETEVENTSREQUEST']._serialized_end = 461
    _globals['_GETEVENTSRESPONSE']._serialized_start = 463
    _globals['_GETEVENTSRESPONSE']._serialized_end = 529
    _globals['_ROADSTATE']._serialized_start = 532
    _globals['_ROADSTATE']._serialized_end = 729
    _globals['_ROADSERVICE']._serialized_start = 1091
    _globals['_ROADSERVICE']._serialized_end = 1332