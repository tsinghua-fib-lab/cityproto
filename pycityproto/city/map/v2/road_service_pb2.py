...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_ROADLEVEL']._serialized_start = 1067
    _globals['_ROADLEVEL']._serialized_end = 1262
    _globals['_INTERRUPTIONREASON']._serialized_start = 1265
    _globals['_INTERRUPTIONREASON']._serialized_end = 1423
    _globals['_GETROADREQUEST']._serialized_start = 129
    _globals['_GETROADREQUEST']._serialized_end = 248
    _globals['_GETROADRESPONSE']._serialized_start = 250
    _globals['_GETROADRESPONSE']._serialized_end = 315
    _globals['_GETROADBYLONGLATBBOXREQUEST']._serialized_start = 318
    _globals['_GETROADBYLONGLATBBOXREQUEST']._serialized_end = 471
    _globals['_GETROADBYLONGLATBBOXRESPONSE']._serialized_start = 473
    _globals['_GETROADBYLONGLATBBOXRESPONSE']._serialized_end = 551
    _globals['_GETRUININFOREQUEST']._serialized_start = 553
    _globals['_GETRUININFOREQUEST']._serialized_end = 573
    _globals['_RUININFO']._serialized_start = 575
    _globals['_RUININFO']._serialized_end = 625
    _globals['_GETRUININFORESPONSE']._serialized_start = 628
    _globals['_GETRUININFORESPONSE']._serialized_end = 776
    _globals['_GETEVENTSREQUEST']._serialized_start = 778
    _globals['_GETEVENTSREQUEST']._serialized_end = 796
    _globals['_GETEVENTSRESPONSE']._serialized_start = 798
    _globals['_GETEVENTSRESPONSE']._serialized_end = 864
    _globals['_ROADSTATE']._serialized_start = 867
    _globals['_ROADSTATE']._serialized_end = 1064
    _globals['_ROADSERVICE']._serialized_start = 1426
    _globals['_ROADSERVICE']._serialized_end = 1776