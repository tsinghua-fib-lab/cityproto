...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_ROADLEVEL']._serialized_start = 1063
    _globals['_ROADLEVEL']._serialized_end = 1258
    _globals['_INTERRUPTIONREASON']._serialized_start = 1261
    _globals['_INTERRUPTIONREASON']._serialized_end = 1419
    _globals['_GETROADREQUEST']._serialized_start = 129
    _globals['_GETROADREQUEST']._serialized_end = 246
    _globals['_GETROADRESPONSE']._serialized_start = 248
    _globals['_GETROADRESPONSE']._serialized_end = 313
    _globals['_GETROADBYLONGLATBBOXREQUEST']._serialized_start = 316
    _globals['_GETROADBYLONGLATBBOXREQUEST']._serialized_end = 467
    _globals['_GETROADBYLONGLATBBOXRESPONSE']._serialized_start = 469
    _globals['_GETROADBYLONGLATBBOXRESPONSE']._serialized_end = 547
    _globals['_GETRUININFOREQUEST']._serialized_start = 549
    _globals['_GETRUININFOREQUEST']._serialized_end = 569
    _globals['_RUININFO']._serialized_start = 571
    _globals['_RUININFO']._serialized_end = 621
    _globals['_GETRUININFORESPONSE']._serialized_start = 624
    _globals['_GETRUININFORESPONSE']._serialized_end = 772
    _globals['_GETEVENTSREQUEST']._serialized_start = 774
    _globals['_GETEVENTSREQUEST']._serialized_end = 792
    _globals['_GETEVENTSRESPONSE']._serialized_start = 794
    _globals['_GETEVENTSRESPONSE']._serialized_end = 860
    _globals['_ROADSTATE']._serialized_start = 863
    _globals['_ROADSTATE']._serialized_end = 1060
    _globals['_ROADSERVICE']._serialized_start = 1422
    _globals['_ROADSERVICE']._serialized_end = 1772