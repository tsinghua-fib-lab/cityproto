...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_GETROUTEREQUEST'].fields_by_name['agent_id']._options = None
    _globals['_GETROUTEREQUEST'].fields_by_name['agent_id']._serialized_options = b'\x18\x01'
    _globals['_GETROUTEREQUEST']._serialized_start = 141
    _globals['_GETROUTEREQUEST']._serialized_end = 343
    _globals['_GETROUTERESPONSE']._serialized_start = 345
    _globals['_GETROUTERESPONSE']._serialized_end = 417
    _globals['_SETDRIVINGCOSTSREQUEST']._serialized_start = 419
    _globals['_SETDRIVINGCOSTSREQUEST']._serialized_end = 488
    _globals['_SETDRIVINGCOSTSRESPONSE']._serialized_start = 490
    _globals['_SETDRIVINGCOSTSRESPONSE']._serialized_end = 515
    _globals['_GETDRIVINGCOSTSREQUEST']._serialized_start = 517
    _globals['_GETDRIVINGCOSTSREQUEST']._serialized_end = 586
    _globals['_GETDRIVINGCOSTSRESPONSE']._serialized_start = 588
    _globals['_GETDRIVINGCOSTSRESPONSE']._serialized_end = 658
    _globals['_ROUTINGSERVICE']._serialized_start = 661
    _globals['_ROUTINGSERVICE']._serialized_end = 962