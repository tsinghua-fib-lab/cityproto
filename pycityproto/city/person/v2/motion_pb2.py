...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_STATUS']._serialized_end = 664
    _globals['_PERSONMOTION']._serialized_start = 71
    _globals['_PERSONMOTION']._serialized_end = 440