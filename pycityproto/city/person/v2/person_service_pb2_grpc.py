...
class PersonServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetAllUnassignedOrders = channel.unary_unary('/city.person.v2.PersonService/GetAllUnassignedOrders', request_serializer=city_dot_person_dot_v2_dot_person__service__pb2.GetAllUnassignedOrdersRequest.SerializeToString, response_deserializer=city_dot_person_dot_v2_dot_person__service__pb2.GetAllUnassignedOrdersResponse.FromString)
...
class PersonServiceServicer(object):
    ...
    def GetAllUnassignedOrders(self, request, context):
        """获取所有待分配的订单信息
...
class PersonService(object):
    ...
    @staticmethod
    def GetAllUnassignedOrders(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/city.person.v2.PersonService/GetAllUnassignedOrders', city_dot_person_dot_v2_dot_person__service__pb2.GetAllUnassignedOrdersRequest.SerializeToString, city_dot_person_dot_v2_dot_person__service__pb2.GetAllUnassignedOrdersResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
