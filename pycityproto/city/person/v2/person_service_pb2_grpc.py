...
class PersonServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetPersonAttribute = channel.unary_unary('/city.person.v2.PersonService/SetPersonAttribute', request_serializer=city_dot_person_dot_v2_dot_person__service__pb2.SetPersonAttributeRequest.SerializeToString, response_deserializer=city_dot_person_dot_v2_dot_person__service__pb2.SetPersonAttributeResponse.FromString)
...
class PersonServiceServicer(object):
    ...
    def SetPersonAttribute(self, request, context):
        """设置人的属性
...
class PersonService(object):
    ...
    @staticmethod
    def SetPersonAttribute(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/city.person.v2.PersonService/SetPersonAttribute', city_dot_person_dot_v2_dot_person__service__pb2.SetPersonAttributeRequest.SerializeToString, city_dot_person_dot_v2_dot_person__service__pb2.SetPersonAttributeResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
