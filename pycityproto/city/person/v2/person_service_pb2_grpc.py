...
class PersonServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetPersonVehicleAttribute = channel.unary_unary('/city.person.v2.PersonService/SetPersonVehicleAttribute', request_serializer=city_dot_person_dot_v2_dot_person__service__pb2.SetPersonVehicleAttributeRequest.SerializeToString, response_deserializer=city_dot_person_dot_v2_dot_person__service__pb2.SetPersonVehicleAttributeResponse.FromString)
        ...
        self.GetGlobalStatistics = channel.unary_unary('/city.person.v2.PersonService/GetGlobalStatistics', request_serializer=city_dot_person_dot_v2_dot_person__service__pb2.GetGlobalStatisticsRequest.SerializeToString, response_deserializer=city_dot_person_dot_v2_dot_person__service__pb2.GetGlobalStatisticsResponse.FromString)
...
class PersonServiceServicer(object):
    ...
    def SetPersonVehicleAttribute(self, request, context):
        """设置车辆的属性
    ...
    def GetGlobalStatistics(self, request, context):
        """获取全局统计信息
...
class PersonService(object):
    ...
    @staticmethod
    def SetPersonVehicleAttribute(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/city.person.v2.PersonService/SetPersonVehicleAttribute', city_dot_person_dot_v2_dot_person__service__pb2.SetPersonVehicleAttributeRequest.SerializeToString, city_dot_person_dot_v2_dot_person__service__pb2.SetPersonVehicleAttributeResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    @staticmethod
    def GetGlobalStatistics(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/city.person.v2.PersonService/GetGlobalStatistics', city_dot_person_dot_v2_dot_person__service__pb2.GetGlobalStatisticsRequest.SerializeToString, city_dot_person_dot_v2_dot_person__service__pb2.GetGlobalStatisticsResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)