...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_GETGLOBALSTATISTICSRESPONSE']._serialized_end = 4183
    _globals['_PERSONSERVICE']._serialized_start = 4186
    _globals['_PERSONSERVICE']._serialized_end = 6568