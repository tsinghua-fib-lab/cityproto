...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_ORDERSTATUS']._serialized_start = 569
    _globals['_ORDERSTATUS']._serialized_end = 724
    _globals['_ALLOCATIONPLANTYPE']._serialized_start = 726
    _globals['_ALLOCATIONPLANTYPE']._serialized_end = 852
    _globals['_REQUESTORDERINFO']._serialized_start = 69
    _globals['_REQUESTORDERINFO']._serialized_end = 341
    _globals['_ORDERALLOCATIONPLAN']._serialized_start = 344
    _globals['_ORDERALLOCATIONPLAN']._serialized_end = 566