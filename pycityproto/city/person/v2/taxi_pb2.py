...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_ALLOCATIONPLANTYPE']._serialized_start = 513
    _globals['_ALLOCATIONPLANTYPE']._serialized_end = 639
    ...
    _globals['_ORDERALLOCATIONPLAN']._serialized_end = 511