...
func file_city_elec_input_v1_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_elec_input_v1_config_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Mongo); i {
			case 0:
				return &v.state
			case 1:
		...
		file_city_elec_input_v1_config_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_city_elec_input_v1_config_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_city_elec_input_v1_config_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_city_elec_input_v1_config_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Output); i {
			case 0:
				return &v.state
			case 1:
		...
		file_city_elec_input_v1_config_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
