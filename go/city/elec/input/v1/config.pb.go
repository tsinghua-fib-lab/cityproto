...
type Mongo struct {
	...
	Facilities *v1.MongoPath `protobuf:"bytes,3,opt,name=facilities,proto3" json:"facilities,omitempty"`
}
...
type OutputSwitch struct {
	...
	Aoi   bool `protobuf:"varint,2,opt,name=aoi,proto3" json:"aoi,omitempty"`
...
var file_city_elec_input_v1_config_proto_rawDesc = []byte{
	...
	0x79, 0x2e, 0x65, 0x6c, 0x65, 0x63, 0x2e, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x2e, 0x76, 0x31, 0x2e,
	0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x52, 0x06, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x42, 0xc9,
	...
	,
...
var file_city_elec_input_v1_config_proto_goTypes = []interface{}{
...
func file_city_elec_input_v1_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_elec_input_v1_config_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Mongo); i {
			case 0:
				return &v.state
			case 1:
		...
		file_city_elec_input_v1_config_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_city_elec_input_v1_config_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_city_elec_input_v1_config_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_city_elec_input_v1_config_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Output); i {
			case 0:
				return &v.state
			case 1:
		...
		file_city_elec_input_v1_config_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
