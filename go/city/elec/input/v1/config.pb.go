...
const file_city_elec_input_v1_config_proto_rawDesc = "" +
	"\n" +
	"\x1fcity/elec/input/v1/config.proto\x12\x12city.elec.input.v1\x1a\x1bcity/config/v1/config.proto\"\x81\x01\n" +
	"\x05Mongo\x12\x10\n" +
	"\x03uri\x18\x01 \x01(\tR\x03uri\x12+\n" +
	"\x03map\x18\x02 \x01(\v2\x19.city.config.v1.MongoPathR\x03map\x129\n" +
	"\n" +
	"facilities\x18\x03 \x01(\v2\x19.city.config.v1.MongoPathR\n" +
	"facilities\"9\n" +
	"\vControlStep\x12\x14\n" +
	"\x05start\x18\x01 \x01(\x05R\x05start\x12\x14\n" +
	"\x05total\x18\x02 \x01(\x05R\x05total\">\n" +
	"\aControl\x123\n" +
	"\x04step\x18\x01 \x01(\v2\x1f.city.elec.input.v1.ControlStepR\x04step\"J\n" +
	"\fOutputSwitch\x12\x12\n" +
	"\x04node\x18\x01 \x01(\bR\x04node\x12\x10\n" +
	"\x03aoi\x18\x02 \x01(\bR\x03aoi\x12\x14\n" +
	"\x05event\x18\x03 \x01(\bR\x05event\"x\n" +
	"\x06Output\x124\n" +
	"\x06target\x18\x01 \x01(\v2\x1c.city.config.v1.OutputTargetR\x06target\x128\n" +
	"\x06switch\x18\x02 \x01(\v2 .city.elec.input.v1.OutputSwitchR\x06switch\"\xa4\x01\n" +
	"\x06Config\x12/\n" +
	"\x05mongo\x18\x01 \x01(\v2\x19.city.elec.input.v1.MongoR\x05mongo\x125\n" +
	"\acontrol\x18\x02 \x01(\v2\x1b.city.elec.input.v1.ControlR\acontrol\x122\n" +
	"\x06output\x18\x03 \x01(\v2\x1a.city.elec.input.v1.OutputR\x06outputB\xcc\x01\n" +
	"\x16com.city.elec.input.v1B\vConfigProtoP\x01Z:git.fiblab.net/sim/protos/v2/go/city/elec/input/v1;inputv1\xa2\x02\x03CEI\xaa\x02\x12City.Elec.Input.V1\xca\x02\x12City\\Elec\\Input\\V1\xe2\x02\x1eCity\\Elec\\Input\\V1\\GPBMetadata\xea\x02\x15City::Elec::Input::V1b\x06proto3"

var (
	file_city_elec_input_v1_config_proto_rawDescOnce sync.Once
	file_city_elec_input_v1_config_proto_rawDescData []byte
)

func file_city_elec_input_v1_config_proto_rawDescGZIP() []byte {
	file_city_elec_input_v1_config_proto_rawDescOnce.Do(func() {
		file_city_elec_input_v1_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_city_elec_input_v1_config_proto_rawDesc), len(file_city_elec_input_v1_config_proto_rawDesc)))
	})
...
func file_city_elec_input_v1_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_city_elec_input_v1_config_proto_rawDesc), len(file_city_elec_input_v1_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
