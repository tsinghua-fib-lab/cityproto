...
const file_city_elec_input_v1_input_service_proto_rawDesc = "" +
	"\n" +
	...
	"\vInitRequest\"\xc3\x01\n" +
	"\fInitResponse\x12\x18\n" +
	"\aaddress\x18\x02 \x01(\tR\aaddress\x125\n" +
	"\acontrol\x18\x03 \x01(\v2\x1b.city.elec.input.v1.ControlR\acontrol\x12>\n" +
	"\n" +
	"facilities\x18\x01 \x01(\v2\x1e.city.elec.input.v1.FacilitiesR\n" +
	"facilities\x12\"\n" +
	...
	"\x16com.city.elec.input.v1B\x11InputServiceProtoP\x01Z:git.fiblab.net/sim/protos/v2/go/city/elec/input/v1;inputv1\xa2\x02\x03CEI\xaa\x02\x12City.Elec.Input.V1\xca\x02\x12City\\Elec\\Input\\V1\xe2\x02\x1eCity\\Elec\\Input\\V1\\GPBMetadata\xea\x02\x15City::Elec::Input::V1b\x06proto3"
