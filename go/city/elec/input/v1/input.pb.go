...
var file_city_elec_input_v1_input_proto_rawDesc = []byte{
	...
	0x6f, 0x2f, 0x76, 0x32, 0x2f, 0x63, 0x69, 0x74, 0x79, 0x2f, 0x65, 0x6c, 0x65, 0x63, 0x2f, 0x69,
...
func file_city_elec_input_v1_input_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_elec_input_v1_input_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_city_elec_input_v1_input_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_city_elec_input_v1_input_proto_msgTypes[2].Exporter = func(v any, i int) any {
