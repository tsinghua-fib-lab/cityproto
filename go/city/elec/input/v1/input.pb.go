...
type RepairStation struct {
	...
	Position *v2.LongLatPosition `protobuf:"bytes,2,opt,name=position,proto3" json:"position,omitempty"`
}
...
type Facility struct {
	...
	Position *v2.LongLatPosition `protobuf:"bytes,2,opt,name=position,proto3" json:"position,omitempty"`
	Type     FacilityType        `protobuf:"varint,3,opt,name=type,proto3,enum=city.elec.input.v1.FacilityType" json:"type,omitempty"`
	// 当前节点的邻居节点的id
	Relation []int32 `protobuf:"varint,4,rep,packed,name=relation,proto3" json:"relation,omitempty"`
	// 在其它关联的网络中如水网使用时，可使用外部id
	// 对于负载，该值表示其在对应模拟中的id
	ForeignId *int32 `protobuf:"varint,5,opt,name=foreign_id,json=foreignId,proto3,oneof" json:"foreign_id,omitempty"`
	// 对于电力设施，该值表示所在aoi id
	AoiId *int32 `protobuf:"varint,6,opt,name=aoi_id,json=aoiId,proto3,oneof" json:"aoi_id,omitempty"`
	// 对于10kv变压器组，该值表示变压器组中变压器的数量
	NumTransformer *int32 `protobuf:"varint,7,opt,name=num_transformer,json=numTransformer,proto3,oneof" json:"num_transformer,omitempty"`
}
