...
func file_city_elec_output_v1_output_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_elec_output_v1_output_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Aoi); i {
			case 0:
				return &v.state
			case 1:
		...
		file_city_elec_output_v1_output_proto_msgTypes[1].Exporter = func(v any, i int) any {
