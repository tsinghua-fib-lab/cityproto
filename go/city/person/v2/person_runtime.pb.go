...
import (
	v2 "git.fiblab.net/sim/protos/go/v2/city/event/v2"
...
var file_city_person_v2_person_runtime_proto_rawDesc = []byte{
	...
	0x6f, 0x73, 0x2f, 0x67, 0x6f, 0x2f, 0x76, 0x32, 0x2f, 0x63, 0x69, 0x74, 0x79, 0x2f, 0x70, 0x65,
...
var (
	...
	file_city_person_v2_person_runtime_proto_rawDescData = file_city_person_v2_person_runtime_proto_rawDesc
)
...
func file_city_person_v2_person_runtime_proto_rawDescGZIP() []byte {
	file_city_person_v2_person_runtime_proto_rawDescOnce.Do(func() {
		file_city_person_v2_person_runtime_proto_rawDescData = protoimpl.X.CompressGZIP(file_city_person_v2_person_runtime_proto_rawDescData)
	})
...
func file_city_person_v2_person_runtime_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_person_v2_person_runtime_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_city_person_v2_person_runtime_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_city_person_v2_person_runtime_proto_rawDesc = nil
