...
const file_city_person_v2_person_runtime_proto_rawDesc = "" +
	"\n" +
	...
	"\rPersonRuntime\x12/\n" +
	"\x04base\x18\x01 \x01(\v2\x16.city.person.v2.PersonH\x00R\x04base\x88\x01\x01\x124\n" +
	...
	"\x05_baseB\xbb\x01\n" +
	"\x12com.city.person.v2B\x12PersonRuntimeProtoP\x01Z7git.fiblab.net/sim/protos/v2/go/city/person/v2;personv2\xa2\x02\x03CPX\xaa\x02\x0eCity.Person.V2\xca\x02\x0eCity\\Person\\V2\xe2\x02\x1aCity\\Person\\V2\\GPBMetadata\xea\x02\x10City::Person::V2b\x06proto3"
