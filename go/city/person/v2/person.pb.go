...
import (
	...
	v21 "git.fiblab.net/sim/protos/go/v2/city/trip/v2"
...
type VehicleEngineEfficiency struct {
	...
	EnergyConversionEfficiency float64 `protobuf:"fixed64,1,opt,name=energy_conversion_efficiency,json=energyConversionEfficiency,proto3" json:"energy_conversion_efficiency,omitempty" db:"energy_conversion_efficiency" yaml:"energy_conversion_efficiency" bson:"energy_conversion_efficiency"`
}
...
type VehicleAttribute struct {
	...
	// 车辆模型标签
	// Vehicle model tag
	Model *string `protobuf:"bytes,11,opt,name=model,proto3,oneof" json:"model,omitempty" db:"model" yaml:"model" bson:"model"`
	// 本车对车道限速认知的偏差百分比
...
type Person struct {
	...
	// 工作地位置
	// work position
	Work *v2.Position `protobuf:"bytes,13,opt,name=work,proto3,oneof" json:"work,omitempty" db:"work" yaml:"work" bson:"work"`
...
var file_city_person_v2_person_proto_rawDesc = []byte{
	...
	0x6d, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x67, 0x6f, 0x2f, 0x76, 0x32, 0x2f, 0x63,
