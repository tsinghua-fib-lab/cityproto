...
type VehicleAttribute struct {
	...
	MaxAcceleration float64 `protobuf:"fixed64,4,opt,name=max_acceleration,json=maxAcceleration,proto3" json:"max_acceleration,omitempty" db:"max_acceleration" yaml:"max_acceleration" bson:"max_acceleration"`
	// 单位: m/s^2, 最大减速度（负值）
