...
type EmissionAttribute struct {
	...
	CoefficientDrag float64 `protobuf:"fixed64,3,opt,name=coefficient_drag,json=coefficientDrag,proto3" json:"coefficient_drag,omitempty" db:"coefficient_drag" yaml:"coefficient_drag" bson:"coefficient_drag"`
	// 路面摩擦系数
...
type VehicleAttribute struct {
	...
	UsualBrakingAcceleration float64 `protobuf:"fixed64,7,opt,name=usual_braking_acceleration,json=usualBrakingAcceleration,proto3" json:"usual_braking_acceleration,omitempty" db:"usual_braking_acceleration" yaml:"usual_braking_acceleration" bson:"usual_braking_acceleration"`
	// 单位: m, 完成变道所需路程
