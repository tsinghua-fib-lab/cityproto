...
type ObservedVehicle struct {
	...
	Relation VehicleRelation `protobuf:"varint,4,opt,name=relation,proto3,enum=city.person.v2.VehicleRelation" json:"relation,omitempty" yaml:"relation" bson:"relation" db:"relation"`
}
...
type ObservedLane struct {
	...
	// 交通灯状态
	// traffic light state
	LightState LightState `protobuf:"varint,3,opt,name=light_state,json=lightState,proto3,enum=city.person.v2.LightState" json:"light_state,omitempty" db:"light_state" yaml:"light_state" bson:"light_state"`
	// 交通灯剩余时间
...
var file_city_person_v2_vehicle_proto_rawDesc = []byte{
	...
	0x6e, 0x2e, 0x76, 0x32, 0x2e, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x4d, 0x6f, 0x74, 0x69, 0x6f,
	...
	0x6e, 0x2e, 0x76, 0x32, 0x2e, 0x4c, 0x43, 0x48, 0x00, 0x52, 0x02, 0x6c, 0x63, 0x88, 0x01, 0x01,
	...
	0x32, 0x2e, 0x56, 0x65, 0x68, 0x69, 0x63, 0x6c, 0x65, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x48,
	...
	0x6f, 0x6e, 0x2e, 0x76, 0x32, 0x2e, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x4d, 0x6f, 0x74, 0x69,
	...
	0x69, 0x74, 0x79, 0x2e, 0x70, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x2e, 0x76, 0x32, 0x2e, 0x4c, 0x69,
	...
	0x72, 0x73, 0x6f, 0x6e, 0x2e, 0x76, 0x32, 0x2e, 0x56, 0x65, 0x68, 0x69, 0x63, 0x6c, 0x65, 0x52,
	...
	0x2e, 0x70, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x2e, 0x76, 0x32, 0x2e, 0x4f, 0x62, 0x73, 0x65, 0x72,
...
var (
	...
	file_city_person_v2_vehicle_proto_rawDescData = file_city_person_v2_vehicle_proto_rawDesc
)

func file_city_person_v2_vehicle_proto_rawDescGZIP() []byte {
	file_city_person_v2_vehicle_proto_rawDescOnce.Do(func() {
		file_city_person_v2_vehicle_proto_rawDescData = protoimpl.X.CompressGZIP(file_city_person_v2_vehicle_proto_rawDescData)
	})
...
var file_city_person_v2_vehicle_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_city_person_v2_vehicle_proto_goTypes = []any{
	...
	(*VehicleRuntime)(nil),  // 4: city.person.v2.VehicleRuntime
	(*ObservedVehicle)(nil), // 5: city.person.v2.ObservedVehicle
	(*ObservedLane)(nil),    // 6: city.person.v2.ObservedLane
	(*VehicleEnv)(nil),      // 7: city.person.v2.VehicleEnv
	(*PersonMotion)(nil),    // 8: city.person.v2.PersonMotion
	(*v2.Journey)(nil),      // 9: city.routing.v2.Journey
}
var file_city_person_v2_vehicle_proto_depIdxs = []int32{
	8,  // 0: city.person.v2.VehicleRuntime.base:type_name -> city.person.v2.PersonMotion
	2,  // 1: city.person.v2.VehicleRuntime.lc:type_name -> city.person.v2.LC
	3,  // 2: city.person.v2.VehicleRuntime.action:type_name -> city.person.v2.VehicleAction
	8,  // 3: city.person.v2.ObservedVehicle.motion:type_name -> city.person.v2.PersonMotion
	0,  // 4: city.person.v2.ObservedVehicle.relation:type_name -> city.person.v2.VehicleRelation
	1,  // 5: city.person.v2.ObservedLane.light_state:type_name -> city.person.v2.LightState
	4,  // 6: city.person.v2.VehicleEnv.runtime:type_name -> city.person.v2.VehicleRuntime
	9,  // 7: city.person.v2.VehicleEnv.journey:type_name -> city.routing.v2.Journey
	5,  // 8: city.person.v2.VehicleEnv.observed_vehicles:type_name -> city.person.v2.ObservedVehicle
	6,  // 9: city.person.v2.VehicleEnv.observed_lanes:type_name -> city.person.v2.ObservedLane
...
func file_city_person_v2_vehicle_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_person_v2_vehicle_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*LC); i {
			case 0:
				return &v.state
			case 1:
		...
		file_city_person_v2_vehicle_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_city_person_v2_vehicle_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_city_person_v2_vehicle_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_city_person_v2_vehicle_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_city_person_v2_vehicle_proto_msgTypes[5].Exporter = func(v any, i int) any {
	...
	file_city_person_v2_vehicle_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_city_person_v2_vehicle_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_city_person_v2_vehicle_proto_rawDesc = nil
