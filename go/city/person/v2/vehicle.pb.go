...
type VehicleRuntime struct {
	...
	EtaFreeFlow float64 `protobuf:"fixed64,10,opt,name=eta_free_flow,json=etaFreeFlow,proto3" json:"eta_free_flow,omitempty" db:"eta_free_flow" yaml:"eta_free_flow" bson:"eta_free_flow"`
	// 碳排放信息
...
type ObservedVehicle struct {
	...
	Relation VehicleRelation `protobuf:"varint,4,opt,name=relation,proto3,enum=city.person.v2.VehicleRelation" json:"relation,omitempty" db:"relation" yaml:"relation" bson:"relation"`
}
