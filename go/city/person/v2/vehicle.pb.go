...
type VehicleRouteAction struct {
	...
	// 新的路径规划结果
	// new routing result
	Journey *v2.Journey `protobuf:"bytes,2,opt,name=journey,proto3" json:"journey,omitempty" yaml:"journey" bson:"journey" db:"journey"`
}
...
type VehicleRuntime struct {
	...
	// 走过的里程
	// running distance
	RunningDistance float64 `protobuf:"fixed64,6,opt,name=running_distance,json=runningDistance,proto3" json:"running_distance,omitempty" db:"running_distance" yaml:"running_distance" bson:"running_distance"`
	// 走错路次数
...
type VehicleEnv struct {
	...
	// 观测到的车辆
	// observed vehicles
	ObservedVehicles []*ObservedVehicle `protobuf:"bytes,4,rep,name=observed_vehicles,json=observedVehicles,proto3" json:"observed_vehicles,omitempty" db:"observed_vehicles" yaml:"observed_vehicles" bson:"observed_vehicles"`
	// 观测到的车道状态
