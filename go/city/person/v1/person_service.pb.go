...
type GetPersonResponse struct {
	...
	Person *PersonRuntime `protobuf:"bytes,1,opt,name=person,proto3" json:"person,omitempty"`
}
...
type GetPersonsRequest struct {
	...
	PersonIds []int32 `protobuf:"varint,1,rep,packed,name=person_ids,json=personIds,proto3" json:"person_ids,omitempty"`
	...
	ExcludeStatuses []Status `protobuf:"varint,2,rep,packed,name=exclude_statuses,json=excludeStatuses,proto3,enum=city.person.v1.Status" json:"exclude_statuses,omitempty"`
	// 设置是否返回base信息
	// Set whether to return base information
	ReturnBase bool `protobuf:"varint,3,opt,name=return_base,json=returnBase,proto3" json:"return_base,omitempty"`
}
...
type GetPersonsResponse struct {
	...
	// person信息
	// person information
	Persons []*PersonRuntime `protobuf:"bytes,1,rep,name=persons,proto3" json:"persons,omitempty"`
}
...
type GetPersonByLongLatBBoxRequest struct {
	...
	Bbox *v21.LongLatBBox `protobuf:"bytes,1,opt,name=bbox,proto3" json:"bbox,omitempty"`
...
type GetAllVehiclesResponse struct {
	...
	Vehicles []*VehicleRuntime `protobuf:"bytes,1,rep,name=vehicles,proto3" json:"vehicles,omitempty"`
}
...
type ResetPersonPositionRequest struct {
	...
	// 重置位置
	// reset position
	Position *v21.Position `protobuf:"bytes,2,opt,name=position,proto3" json:"position,omitempty"`
}
...
type FetchControlledVehicleEnvsResponse struct {
	...
	VehicleEnvs []*VehicleEnv `protobuf:"bytes,1,rep,name=vehicle_envs,json=vehicleEnvs,proto3" json:"vehicle_envs,omitempty"`
}
...
type SetControlledVehicleActionsRequest struct {
	...
	VehicleActions []*VehicleAction `protobuf:"bytes,1,rep,name=vehicle_actions,json=vehicleActions,proto3" json:"vehicle_actions,omitempty"`
}
...
var file_city_person_v1_person_service_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x3b, 0x70, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x76, 0x31, 0xa2, 0x02, 0x03, 0x43, 0x50,
	0x58, 0xaa, 0x02, 0x0e, 0x43, 0x69, 0x74, 0x79, 0x2e, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x2e,
	0x56, 0x31, 0xca, 0x02, 0x0e, 0x43, 0x69, 0x74, 0x79, 0x5c, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e,
	0x5c, 0x56, 0x31, 0xe2, 0x02, 0x1a, 0x43, 0x69, 0x74, 0x79, 0x5c, 0x50, 0x65, 0x72, 0x73, 0x6f,
