...
// 获取特定区域内的person请求
type GetPersonsByLongLatAreaRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetPersonsByLongLatAreaRequest) Reset() {
	*x = GetPersonsByLongLatAreaRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetPersonsByLongLatAreaRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPersonsByLongLatAreaRequest) ProtoMessage() {}

func (x *GetPersonsByLongLatAreaRequest) ProtoReflect() protoreflect.Message {
	mi := &file_city_person_v1_person_service_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPersonsByLongLatAreaRequest.ProtoReflect.Descriptor instead.
func (*GetPersonsByLongLatAreaRequest) Descriptor() ([]byte, []int) {
	return file_city_person_v1_person_service_proto_rawDescGZIP(), []int{6}
}

func (x *GetPersonsByLongLatAreaRequest) GetArea() *v21.LongLatRectArea {
	if x != nil {
		return x.Area
	}
	return nil
...
// 获取特定区域内的person响应
type GetPersonsByLongLatAreaResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetPersonsByLongLatAreaResponse) Reset() {
	*x = GetPersonsByLongLatAreaResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetPersonsByLongLatAreaResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPersonsByLongLatAreaResponse) ProtoMessage() {}

func (x *GetPersonsByLongLatAreaResponse) ProtoReflect() protoreflect.Message {
	mi := &file_city_person_v1_person_service_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPersonsByLongLatAreaResponse.ProtoReflect.Descriptor instead.
func (*GetPersonsByLongLatAreaResponse) Descriptor() ([]byte, []int) {
	return file_city_person_v1_person_service_proto_rawDescGZIP(), []int{7}
}

func (x *GetPersonsByLongLatAreaResponse) GetStep() int32 {
	if x != nil {
		return x.Step
	}
	return 0
...
func (x *GetPersonsByLongLatAreaResponse) GetMotions() []*PersonMotion {
	if x != nil {
		return x.Motions
	}
	return nil
...
var file_city_person_v1_person_service_proto_rawDesc = []byte{
	...
	,
...
var file_city_person_v1_person_service_proto_goTypes = []interface{}{
	...
	(*GetPersonsByLongLatAreaRequest)(nil),  // 6: city.person.v1.GetPersonsByLongLatAreaRequest
	(*GetPersonsByLongLatAreaResponse)(nil), // 7: city.person.v1.GetPersonsByLongLatAreaResponse
	(*Person)(nil),                          // 8: city.person.v1.Person
	(*PersonMotion)(nil),                    // 9: city.person.v1.PersonMotion
	(*v2.Schedule)(nil),                     // 10: city.trip.v2.Schedule
	(*v21.LongLatRectArea)(nil),             // 11: city.geo.v2.LongLatRectArea
}
var file_city_person_v1_person_service_proto_depIdxs = []int32{
	...
	11, // 4: city.person.v1.GetPersonsByLongLatAreaRequest.area:type_name -> city.geo.v2.LongLatRectArea
	9,  // 5: city.person.v1.GetPersonsByLongLatAreaResponse.motions:type_name -> city.person.v1.PersonMotion
	0,  // 6: city.person.v1.PersonService.GetPerson:input_type -> city.person.v1.GetPersonRequest
	2,  // 7: city.person.v1.PersonService.AddPerson:input_type -> city.person.v1.AddPersonRequest
	4,  // 8: city.person.v1.PersonService.SetSchedule:input_type -> city.person.v1.SetScheduleRequest
	6,  // 9: city.person.v1.PersonService.GetPersonsByLongLatArea:input_type -> city.person.v1.GetPersonsByLongLatAreaRequest
	1,  // 10: city.person.v1.PersonService.GetPerson:output_type -> city.person.v1.GetPersonResponse
	3,  // 11: city.person.v1.PersonService.AddPerson:output_type -> city.person.v1.AddPersonResponse
	5,  // 12: city.person.v1.PersonService.SetSchedule:output_type -> city.person.v1.SetScheduleResponse
	7,  // 13: city.person.v1.PersonService.GetPersonsByLongLatArea:output_type -> city.person.v1.GetPersonsByLongLatAreaResponse
...
func file_city_person_v1_person_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_city_person_v1_person_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetPersonsByLongLatAreaRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_city_person_v1_person_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetPersonsByLongLatAreaResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
