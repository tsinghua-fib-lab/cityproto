...
type VehicleRuntime struct {
	...
	BaseOnRoad *BaseRuntimeOnRoad `protobuf:"bytes,2,opt,name=base_on_road,json=baseOnRoad,proto3" json:"base_on_road,omitempty" yaml:"base_on_road" bson:"base_on_road" db:"base_on_road"`
	// 距终点的距离
	// distance to the end
...
type ObservedVehicle struct {
	...
	// 相对距离
	// relative distance
	RelativeDistance float64 `protobuf:"fixed64,3,opt,name=relative_distance,json=relativeDistance,proto3" json:"relative_distance,omitempty" db:"relative_distance" yaml:"relative_distance" bson:"relative_distance"`
	// 关系枚举
...
type ObservedLane struct {
	...
	LightRemainingTime float64 `protobuf:"fixed64,4,opt,name=light_remaining_time,json=lightRemainingTime,proto3" json:"light_remaining_time,omitempty" db:"light_remaining_time" yaml:"light_remaining_time" bson:"light_remaining_time"`
}
...
var file_city_person_v1_vehicle_proto_rawDesc = []byte{
	...
	0x22, 0xd7, 0x03, 0x0a, 0x0e, 0x56, 0x65, 0x68, 0x69, 0x63, 0x6c, 0x65, 0x52, 0x75, 0x6e, 0x74,
	...
	0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x56, 0x65, 0x68, 0x69, 0x63, 0x6c, 0x65, 0x52, 0x65, 0x6c, 0x61,
	...
	0x72, 0x73, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x69, 0x67, 0x68, 0x74, 0x53, 0x74, 0x61,
	...
	0x31, 0x2e, 0x56, 0x65, 0x68, 0x69, 0x63, 0x6c, 0x65, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65,
	...
	0x70, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76,
	...
	0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x64, 0x4c, 0x61, 0x6e,
	...
	0x54, 0x41, 0x54, 0x45, 0x5f, 0x59, 0x45, 0x4c, 0x4c, 0x4f, 0x57, 0x10, 0x03, 0x42, 0xb2, 0x01,
	0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x69, 0x74, 0x79, 0x2e, 0x70, 0x65, 0x72, 0x73, 0x6f,
	0x6e, 0x2e, 0x76, 0x31, 0x42, 0x0c, 0x56, 0x65, 0x68, 0x69, 0x63, 0x6c, 0x65, 0x50, 0x72, 0x6f,
	...
	0x31, 0x3b, 0x70, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x76, 0x31, 0xa2, 0x02, 0x03, 0x43, 0x50, 0x58,
	0xaa, 0x02, 0x0e, 0x43, 0x69, 0x74, 0x79, 0x2e, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x2e, 0x56,
	0x31, 0xca, 0x02, 0x0e, 0x43, 0x69, 0x74, 0x79, 0x5c, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x5c,
	0x56, 0x31, 0xe2, 0x02, 0x1a, 0x43, 0x69, 0x74, 0x79, 0x5c, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e,
...
func file_city_person_v1_vehicle_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_person_v1_vehicle_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*LC); i {
			case 0:
				return &v.state
			case 1:
		...
		file_city_person_v1_vehicle_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_city_person_v1_vehicle_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_city_person_v1_vehicle_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_city_person_v1_vehicle_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_city_person_v1_vehicle_proto_msgTypes[5].Exporter = func(v any, i int) any {
