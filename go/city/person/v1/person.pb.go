...
type PersonAttribute struct {
	...
	// 单位: m/s
	// max speed: m/s
	MaxSpeed float64 `protobuf:"fixed64,4,opt,name=max_speed,json=maxSpeed,proto3" json:"max_speed,omitempty"`
	// 单位: m/s^2, 最大加速度（正值）
	// max accelaration: m/s^2 (positive value)
	MaxAcceleration float64 `protobuf:"fixed64,5,opt,name=max_acceleration,json=maxAcceleration,proto3" json:"max_acceleration,omitempty"`
	// 单位: m/s^2, 最大减速度（负值）
	// max deceleration: m/s^2 (negative value)
	MaxBrakingAcceleration float64 `protobuf:"fixed64,6,opt,name=max_braking_acceleration,json=maxBrakingAcceleration,proto3" json:"max_braking_acceleration,omitempty"`
	// 单位: m/s^2, 一般加速度（正值），要求小于最大加速度
	// usual acceleration: m/s^2 (positive value), required to be less than the max acceleration
	UsualAcceleration float64 `protobuf:"fixed64,7,opt,name=usual_acceleration,json=usualAcceleration,proto3" json:"usual_acceleration,omitempty"`
	// 单位: m/s^2, 一般减速度（负值），要求大于最大减速度
	// usual deceleration: m/s^2 (negative value), required to be greater than the max deceleration
	UsualBrakingAcceleration float64 `protobuf:"fixed64,8,opt,name=usual_braking_acceleration,json=usualBrakingAcceleration,proto3" json:"usual_braking_acceleration,omitempty"`
}
...
type VehicleAttribute struct {
	...
	LaneChangeLength float64 `protobuf:"fixed64,1,opt,name=lane_change_length,json=laneChangeLength,proto3" json:"lane_change_length,omitempty"`
	// 单位：米，本车距离前车的最小距离
	// The minimum distance between the vehicle and the vehicle in front: m
	MinGap float64 `protobuf:"fixed64,2,opt,name=min_gap,json=minGap,proto3" json:"min_gap,omitempty"`
	// 车辆模型标签
	// Vehicle model tag
...
type BusAttribute struct {
	...
	// 公交线路ID
	// bus line ID
	SublineId int32 `protobuf:"varint,1,opt,name=subline_id,json=sublineId,proto3" json:"subline_id,omitempty"`
	// 公交车容量
	// bus capacity
	...
	// 公交车类型
	// type of bus
	Type BusType `protobuf:"varint,5,opt,name=type,proto3,enum=city.person.v1.BusType" json:"type,omitempty"`
}
...
type PersonProfile struct {
	...
	// 教育水平
	// education level
	Education Education `protobuf:"varint,2,opt,name=education,proto3,enum=city.person.v1.Education" json:"education,omitempty"`
	// 性别
	// gender
	Gender Gender `protobuf:"varint,3,opt,name=gender,proto3,enum=city.person.v1.Gender" json:"gender,omitempty"`
	// 消费水平
	// consumption level
	Consumption Consumption `protobuf:"varint,4,opt,name=consumption,proto3,enum=city.person.v1.Consumption" json:"consumption,omitempty"`
	// 房屋ID 区分不同家庭
...
type Person struct {
	...
	// 参数
	// attribute
	Attribute *PersonAttribute `protobuf:"bytes,2,opt,name=attribute,proto3" json:"attribute,omitempty"`
	// 初始位置
	// initial position
	Home *v2.Position `protobuf:"bytes,3,opt,name=home,proto3" json:"home,omitempty"`
	// 初始日程
	// initial schedules
	Schedules []*v21.Schedule `protobuf:"bytes,4,rep,name=schedules,proto3" json:"schedules,omitempty"`
	// 车辆附加属性
	// vehicle addtional attribute
	VehicleAttribute *VehicleAttribute `protobuf:"bytes,7,opt,name=vehicle_attribute,json=vehicleAttribute,proto3,oneof" json:"vehicle_attribute,omitempty"`
	// 公交车附加属性
	// bus additional attribute
	BusAttribute *BusAttribute `protobuf:"bytes,8,opt,name=bus_attribute,json=busAttribute,proto3,oneof" json:"bus_attribute,omitempty"`
	// 行人附加属性
	// pedestrian additional attribute
	PedestrianAttribute *PedestrianAttribute `protobuf:"bytes,12,opt,name=pedestrian_attribute,json=pedestrianAttribute,proto3,oneof" json:"pedestrian_attribute,omitempty"`
	// 自行车附加属性
	// bike addition attribute
	BikeAttribute *BikeAttribute `protobuf:"bytes,9,opt,name=bike_attribute,json=bikeAttribute,proto3,oneof" json:"bike_attribute,omitempty"`
	...
	Profile *PersonProfile `protobuf:"bytes,11,opt,name=profile,proto3,oneof" json:"profile,omitempty"`
	// 工作地位置
	// work position
	Work *v2.Position `protobuf:"bytes,13,opt,name=work,proto3,oneof" json:"work,omitempty"`
	// 是否在SLEEP状态下也输出可视化（仅限车辆）
	// Whether to output visualization in the SLEEP state (vehicles only)
	OutputWhenSleep *bool `protobuf:"varint,14,opt,name=output_when_sleep,json=outputWhenSleep,proto3,oneof" json:"output_when_sleep,omitempty"`
}
...
var file_city_person_v1_person_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x42, 0x07, 0x0a, 0x05, 0x5f, 0x77, 0x6f, 0x72, 0x6b, 0x42,
	0x14, 0x0a, 0x12, 0x5f, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x5f, 0x77, 0x68, 0x65, 0x6e, 0x5f,
	0x73, 0x6c, 0x65, 0x65, 0x70, 0x22, 0x3b, 0x0a, 0x07, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x73,
	0x12, 0x30, 0x0a, 0x07, 0x70, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28,
	...
	,
	...
	,
