...
var file_city_economy_v2_org_service_proto_rawDesc = []byte{
	...
	0x05, 0x52, 0x08, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x73, 0x12, 0x17, 0x0a, 0x07, 0x6f,
	0x72, 0x67, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x05, 0x52, 0x06, 0x6f, 0x72,
	0x67, 0x49, 0x64, 0x73, 0x22, 0x36, 0x0a, 0x1d, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x73, 0x75,
	...
	0x52, 0x61, 0x74, 0x65, 0x32, 0x87, 0x25, 0x0a, 0x0a, 0x4f, 0x72, 0x67, 0x53, 0x65, 0x72, 0x76,
	...
	0x69, 0x74, 0x79, 0x49, 0x64, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0xbf,
...
var file_city_economy_v2_org_service_proto_msgTypes = make([]protoimpl.MessageInfo, 96)
var file_city_economy_v2_org_service_proto_goTypes = []any{
	...
	(*GetConsumptionCurrencyRequest)(nil),    // 62: city.economy.v2.GetConsumptionCurrencyRequest
	(*GetConsumptionCurrencyResponse)(nil),   // 63: city.economy.v2.GetConsumptionCurrencyResponse
	(*SetConsumptionCurrencyRequest)(nil),    // 64: city.economy.v2.SetConsumptionCurrencyRequest
	(*SetConsumptionCurrencyResponse)(nil),   // 65: city.economy.v2.SetConsumptionCurrencyResponse
	(*GetConsumptionPropensityRequest)(nil),  // 66: city.economy.v2.GetConsumptionPropensityRequest
	(*GetConsumptionPropensityResponse)(nil), // 67: city.economy.v2.GetConsumptionPropensityResponse
	(*SetConsumptionPropensityRequest)(nil),  // 68: city.economy.v2.SetConsumptionPropensityRequest
	(*SetConsumptionPropensityResponse)(nil), // 69: city.economy.v2.SetConsumptionPropensityResponse
	(*GetIncomeCurrencyRequest)(nil),         // 70: city.economy.v2.GetIncomeCurrencyRequest
	(*GetIncomeCurrencyResponse)(nil),        // 71: city.economy.v2.GetIncomeCurrencyResponse
	(*SetIncomeCurrencyRequest)(nil),         // 72: city.economy.v2.SetIncomeCurrencyRequest
	(*SetIncomeCurrencyResponse)(nil),        // 73: city.economy.v2.SetIncomeCurrencyResponse
	(*GetDepressionRequest)(nil),             // 74: city.economy.v2.GetDepressionRequest
	(*GetDepressionResponse)(nil),            // 75: city.economy.v2.GetDepressionResponse
	(*SetDepressionRequest)(nil),             // 76: city.economy.v2.SetDepressionRequest
	(*SetDepressionResponse)(nil),            // 77: city.economy.v2.SetDepressionResponse
	(*GetLocusControlRequest)(nil),           // 78: city.economy.v2.GetLocusControlRequest
	(*GetLocusControlResponse)(nil),          // 79: city.economy.v2.GetLocusControlResponse
	(*SetLocusControlRequest)(nil),           // 80: city.economy.v2.SetLocusControlRequest
	(*SetLocusControlResponse)(nil),          // 81: city.economy.v2.SetLocusControlResponse
	(*GetWorkingHoursRequest)(nil),           // 82: city.economy.v2.GetWorkingHoursRequest
	(*GetWorkingHoursResponse)(nil),          // 83: city.economy.v2.GetWorkingHoursResponse
	(*SetWorkingHoursRequest)(nil),           // 84: city.economy.v2.SetWorkingHoursRequest
	(*SetWorkingHoursResponse)(nil),          // 85: city.economy.v2.SetWorkingHoursResponse
	(*GetOrgEntityIdsRequest)(nil),           // 86: city.economy.v2.GetOrgEntityIdsRequest
	(*GetOrgEntityIdsResponse)(nil),          // 87: city.economy.v2.GetOrgEntityIdsResponse
	(*AddInventoryRequest)(nil),              // 88: city.economy.v2.AddInventoryRequest
	(*AddInventoryResponse)(nil),             // 89: city.economy.v2.AddInventoryResponse
	(*AddPriceRequest)(nil),                  // 90: city.economy.v2.AddPriceRequest
	(*AddPriceResponse)(nil),                 // 91: city.economy.v2.AddPriceResponse
	(*AddCurrencyRequest)(nil),               // 92: city.economy.v2.AddCurrencyRequest
	(*AddCurrencyResponse)(nil),              // 93: city.economy.v2.AddCurrencyResponse
	(*AddInterestRateRequest)(nil),           // 94: city.economy.v2.AddInterestRateRequest
	(*AddInterestRateResponse)(nil),          // 95: city.economy.v2.AddInterestRateResponse
	(*Org)(nil),                              // 96: city.economy.v2.Org
	(*Agent)(nil),                            // 97: city.economy.v2.Agent
	(OrgType)(0),                             // 98: city.economy.v2.OrgType
}
var file_city_economy_v2_org_service_proto_depIdxs = []int32{
	96, // 0: city.economy.v2.AddOrgRequest.org:type_name -> city.economy.v2.Org
	97, // 1: city.economy.v2.AddAgentRequest.agent:type_name -> city.economy.v2.Agent
	98, // 2: city.economy.v2.GetOrgEntityIdsRequest.type:type_name -> city.economy.v2.OrgType
	0,  // 3: city.economy.v2.OrgService.AddOrg:input_type -> city.economy.v2.AddOrgRequest
	2,  // 4: city.economy.v2.OrgService.RemoveOrg:input_type -> city.economy.v2.RemoveOrgRequest
	4,  // 5: city.economy.v2.OrgService.AddAgent:input_type -> city.economy.v2.AddAgentRequest
	6,  // 6: city.economy.v2.OrgService.RemoveAgent:input_type -> city.economy.v2.RemoveAgentRequest
	8,  // 7: city.economy.v2.OrgService.GetNominalGDP:input_type -> city.economy.v2.GetNominalGDPRequest
	10, // 8: city.economy.v2.OrgService.SetNominalGDP:input_type -> city.economy.v2.SetNominalGDPRequest
	12, // 9: city.economy.v2.OrgService.GetRealGDP:input_type -> city.economy.v2.GetRealGDPRequest
	14, // 10: city.economy.v2.OrgService.SetRealGDP:input_type -> city.economy.v2.SetRealGDPRequest
	16, // 11: city.economy.v2.OrgService.GetUnemployment:input_type -> city.economy.v2.GetUnemploymentRequest
	18, // 12: city.economy.v2.OrgService.SetUnemployment:input_type -> city.economy.v2.SetUnemploymentRequest
	20, // 13: city.economy.v2.OrgService.GetWages:input_type -> city.economy.v2.GetWagesRequest
	22, // 14: city.economy.v2.OrgService.SetWages:input_type -> city.economy.v2.SetWagesRequest
	24, // 15: city.economy.v2.OrgService.GetPrices:input_type -> city.economy.v2.GetPricesRequest
	26, // 16: city.economy.v2.OrgService.SetPrices:input_type -> city.economy.v2.SetPricesRequest
	28, // 17: city.economy.v2.OrgService.GetInventory:input_type -> city.economy.v2.GetInventoryRequest
	30, // 18: city.economy.v2.OrgService.SetInventory:input_type -> city.economy.v2.SetInventoryRequest
	88, // 19: city.economy.v2.OrgService.AddInventory:input_type -> city.economy.v2.AddInventoryRequest
	32, // 20: city.economy.v2.OrgService.GetPrice:input_type -> city.economy.v2.GetPriceRequest
	34, // 21: city.economy.v2.OrgService.SetPrice:input_type -> city.economy.v2.SetPriceRequest
	90, // 22: city.economy.v2.OrgService.AddPrice:input_type -> city.economy.v2.AddPriceRequest
	36, // 23: city.economy.v2.OrgService.GetCurrency:input_type -> city.economy.v2.GetCurrencyRequest
	38, // 24: city.economy.v2.OrgService.SetCurrency:input_type -> city.economy.v2.SetCurrencyRequest
	92, // 25: city.economy.v2.OrgService.AddCurrency:input_type -> city.economy.v2.AddCurrencyRequest
	40, // 26: city.economy.v2.OrgService.GetInterestRate:input_type -> city.economy.v2.GetInterestRateRequest
	42, // 27: city.economy.v2.OrgService.SetInterestRate:input_type -> city.economy.v2.SetInterestRateRequest
	94, // 28: city.economy.v2.OrgService.AddInterestRate:input_type -> city.economy.v2.AddInterestRateRequest
	44, // 29: city.economy.v2.OrgService.GetBracketCutoffs:input_type -> city.economy.v2.GetBracketCutoffsRequest
	46, // 30: city.economy.v2.OrgService.SetBracketCutoffs:input_type -> city.economy.v2.SetBracketCutoffsRequest
	48, // 31: city.economy.v2.OrgService.GetBracketRates:input_type -> city.economy.v2.GetBracketRatesRequest
	50, // 32: city.economy.v2.OrgService.SetBracketRates:input_type -> city.economy.v2.SetBracketRatesRequest
	52, // 33: city.economy.v2.OrgService.CalculateTaxesDue:input_type -> city.economy.v2.CalculateTaxesDueRequest
	54, // 34: city.economy.v2.OrgService.CalculateConsumption:input_type -> city.economy.v2.CalculateConsumptionRequest
	56, // 35: city.economy.v2.OrgService.CalculateInterest:input_type -> city.economy.v2.CalculateInterestRequest
	58, // 36: city.economy.v2.OrgService.SaveEconomyEntities:input_type -> city.economy.v2.SaveEconomyEntitiesRequest
	60, // 37: city.economy.v2.OrgService.LoadEconomyEntities:input_type -> city.economy.v2.LoadEconomyEntitiesRequest
	62, // 38: city.economy.v2.OrgService.GetConsumptionCurrency:input_type -> city.economy.v2.GetConsumptionCurrencyRequest
	64, // 39: city.economy.v2.OrgService.SetConsumptionCurrency:input_type -> city.economy.v2.SetConsumptionCurrencyRequest
	66, // 40: city.economy.v2.OrgService.GetConsumptionPropensity:input_type -> city.economy.v2.GetConsumptionPropensityRequest
	68, // 41: city.economy.v2.OrgService.SetConsumptionPropensity:input_type -> city.economy.v2.SetConsumptionPropensityRequest
	70, // 42: city.economy.v2.OrgService.GetIncomeCurrency:input_type -> city.economy.v2.GetIncomeCurrencyRequest
	72, // 43: city.economy.v2.OrgService.SetIncomeCurrency:input_type -> city.economy.v2.SetIncomeCurrencyRequest
	74, // 44: city.economy.v2.OrgService.GetDepression:input_type -> city.economy.v2.GetDepressionRequest
	76, // 45: city.economy.v2.OrgService.SetDepression:input_type -> city.economy.v2.SetDepressionRequest
	78, // 46: city.economy.v2.OrgService.GetLocusControl:input_type -> city.economy.v2.GetLocusControlRequest
	80, // 47: city.economy.v2.OrgService.SetLocusControl:input_type -> city.economy.v2.SetLocusControlRequest
	82, // 48: city.economy.v2.OrgService.GetWorkingHours:input_type -> city.economy.v2.GetWorkingHoursRequest
	84, // 49: city.economy.v2.OrgService.SetWorkingHours:input_type -> city.economy.v2.SetWorkingHoursRequest
	86, // 50: city.economy.v2.OrgService.GetOrgEntityIds:input_type -> city.economy.v2.GetOrgEntityIdsRequest
	1,  // 51: city.economy.v2.OrgService.AddOrg:output_type -> city.economy.v2.AddOrgResponse
	3,  // 52: city.economy.v2.OrgService.RemoveOrg:output_type -> city.economy.v2.RemoveOrgResponse
	5,  // 53: city.economy.v2.OrgService.AddAgent:output_type -> city.economy.v2.AddAgentResponse
	7,  // 54: city.economy.v2.OrgService.RemoveAgent:output_type -> city.economy.v2.RemoveAgentResponse
	9,  // 55: city.economy.v2.OrgService.GetNominalGDP:output_type -> city.economy.v2.GetNominalGDPResponse
	11, // 56: city.economy.v2.OrgService.SetNominalGDP:output_type -> city.economy.v2.SetNominalGDPResponse
	13, // 57: city.economy.v2.OrgService.GetRealGDP:output_type -> city.economy.v2.GetRealGDPResponse
	15, // 58: city.economy.v2.OrgService.SetRealGDP:output_type -> city.economy.v2.SetRealGDPResponse
	17, // 59: city.economy.v2.OrgService.GetUnemployment:output_type -> city.economy.v2.GetUnemploymentResponse
	19, // 60: city.economy.v2.OrgService.SetUnemployment:output_type -> city.economy.v2.SetUnemploymentResponse
	21, // 61: city.economy.v2.OrgService.GetWages:output_type -> city.economy.v2.GetWagesResponse
	23, // 62: city.economy.v2.OrgService.SetWages:output_type -> city.economy.v2.SetWagesResponse
	25, // 63: city.economy.v2.OrgService.GetPrices:output_type -> city.economy.v2.GetPricesResponse
	27, // 64: city.economy.v2.OrgService.SetPrices:output_type -> city.economy.v2.SetPricesResponse
	29, // 65: city.economy.v2.OrgService.GetInventory:output_type -> city.economy.v2.GetInventoryResponse
	31, // 66: city.economy.v2.OrgService.SetInventory:output_type -> city.economy.v2.SetInventoryResponse
	89, // 67: city.economy.v2.OrgService.AddInventory:output_type -> city.economy.v2.AddInventoryResponse
	33, // 68: city.economy.v2.OrgService.GetPrice:output_type -> city.economy.v2.GetPriceResponse
	35, // 69: city.economy.v2.OrgService.SetPrice:output_type -> city.economy.v2.SetPriceResponse
	91, // 70: city.economy.v2.OrgService.AddPrice:output_type -> city.economy.v2.AddPriceResponse
	37, // 71: city.economy.v2.OrgService.GetCurrency:output_type -> city.economy.v2.GetCurrencyResponse
	39, // 72: city.economy.v2.OrgService.SetCurrency:output_type -> city.economy.v2.SetCurrencyResponse
	93, // 73: city.economy.v2.OrgService.AddCurrency:output_type -> city.economy.v2.AddCurrencyResponse
	41, // 74: city.economy.v2.OrgService.GetInterestRate:output_type -> city.economy.v2.GetInterestRateResponse
	43, // 75: city.economy.v2.OrgService.SetInterestRate:output_type -> city.economy.v2.SetInterestRateResponse
	95, // 76: city.economy.v2.OrgService.AddInterestRate:output_type -> city.economy.v2.AddInterestRateResponse
	45, // 77: city.economy.v2.OrgService.GetBracketCutoffs:output_type -> city.economy.v2.GetBracketCutoffsResponse
	47, // 78: city.economy.v2.OrgService.SetBracketCutoffs:output_type -> city.economy.v2.SetBracketCutoffsResponse
	49, // 79: city.economy.v2.OrgService.GetBracketRates:output_type -> city.economy.v2.GetBracketRatesResponse
	51, // 80: city.economy.v2.OrgService.SetBracketRates:output_type -> city.economy.v2.SetBracketRatesResponse
	53, // 81: city.economy.v2.OrgService.CalculateTaxesDue:output_type -> city.economy.v2.CalculateTaxesDueResponse
	55, // 82: city.economy.v2.OrgService.CalculateConsumption:output_type -> city.economy.v2.CalculateConsumptionResponse
	57, // 83: city.economy.v2.OrgService.CalculateInterest:output_type -> city.economy.v2.CalculateInterestResponse
	59, // 84: city.economy.v2.OrgService.SaveEconomyEntities:output_type -> city.economy.v2.SaveEconomyEntitiesResponse
	61, // 85: city.economy.v2.OrgService.LoadEconomyEntities:output_type -> city.economy.v2.LoadEconomyEntitiesResponse
	63, // 86: city.economy.v2.OrgService.GetConsumptionCurrency:output_type -> city.economy.v2.GetConsumptionCurrencyResponse
	65, // 87: city.economy.v2.OrgService.SetConsumptionCurrency:output_type -> city.economy.v2.SetConsumptionCurrencyResponse
	67, // 88: city.economy.v2.OrgService.GetConsumptionPropensity:output_type -> city.economy.v2.GetConsumptionPropensityResponse
	69, // 89: city.economy.v2.OrgService.SetConsumptionPropensity:output_type -> city.economy.v2.SetConsumptionPropensityResponse
	71, // 90: city.economy.v2.OrgService.GetIncomeCurrency:output_type -> city.economy.v2.GetIncomeCurrencyResponse
	73, // 91: city.economy.v2.OrgService.SetIncomeCurrency:output_type -> city.economy.v2.SetIncomeCurrencyResponse
	75, // 92: city.economy.v2.OrgService.GetDepression:output_type -> city.economy.v2.GetDepressionResponse
	77, // 93: city.economy.v2.OrgService.SetDepression:output_type -> city.economy.v2.SetDepressionResponse
	79, // 94: city.economy.v2.OrgService.GetLocusControl:output_type -> city.economy.v2.GetLocusControlResponse
	81, // 95: city.economy.v2.OrgService.SetLocusControl:output_type -> city.economy.v2.SetLocusControlResponse
	83, // 96: city.economy.v2.OrgService.GetWorkingHours:output_type -> city.economy.v2.GetWorkingHoursResponse
	85, // 97: city.economy.v2.OrgService.SetWorkingHours:output_type -> city.economy.v2.SetWorkingHoursResponse
	87, // 98: city.economy.v2.OrgService.GetOrgEntityIds:output_type -> city.economy.v2.GetOrgEntityIdsResponse
