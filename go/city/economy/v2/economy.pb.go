...
const file_city_economy_v2_economy_proto_rawDesc = "" +
	"\n" +
	...
	"\bcurrency\x18\a \x01(\x02R\bcurrency\"\xd2\v\n" +
	"\x03NBS\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\x12\x1f\n" +
	"\vcitizen_ids\x18\x02 \x03(\x05R\n" +
	"citizenIds\x12E\n" +
	"\vnominal_gdp\x18\x03 \x03(\v2$.city.economy.v2.NBS.NominalGdpEntryR\n" +
	"nominalGdp\x12<\n" +
	"\breal_gdp\x18\x04 \x03(\v2!.city.economy.v2.NBS.RealGdpEntryR\arealGdp\x12J\n" +
	"\funemployment\x18\x05 \x03(\v2&.city.economy.v2.NBS.UnemploymentEntryR\funemployment\x125\n" +
	"\x05wages\x18\x06 \x03(\v2\x1f.city.economy.v2.NBS.WagesEntryR\x05wages\x128\n" +
	"\x06prices\x18\a \x03(\v2 .city.economy.v2.NBS.PricesEntryR\x06prices\x12K\n" +
	"\rworking_hours\x18\b \x03(\v2&.city.economy.v2.NBS.WorkingHoursEntryR\fworkingHours\x12D\n" +
	"\n" +
	"depression\x18\t \x03(\v2$.city.economy.v2.NBS.DepressionEntryR\n" +
	"depression\x12`\n" +
	"\x14consumption_currency\x18\n" +
	" \x03(\v2-.city.economy.v2.NBS.ConsumptionCurrencyEntryR\x13consumptionCurrency\x12Q\n" +
	"\x0fincome_currency\x18\v \x03(\v2(.city.economy.v2.NBS.IncomeCurrencyEntryR\x0eincomeCurrency\x12K\n" +
	"\rlocus_control\x18\f \x03(\v2&.city.economy.v2.NBS.LocusControlEntryR\flocusControl\x12*\n" +
	"\x11citizen_agent_ids\x18\r \x03(\x05R\x0fcitizenAgentIds\x12\x1a\n" +
	"\bcurrency\x18\x0e \x01(\x02R\bcurrency\x1a=\n" +
	"\x0fNominalGdpEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x02R\x05value:\x028\x01\x1a:\n" +
	"\fRealGdpEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x02R\x05value:\x028\x01\x1a?\n" +
	...
	"\rbracket_rates\x18\x04 \x03(\x02R\fbracketRates\x12\x1a\n" +
	"\bcurrency\x18\x05 \x01(\x02R\bcurrency\"x\n" +
	"\x04Bank\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\x12\x1f\n" +
	"\vcitizen_ids\x18\x02 \x03(\x05R\n" +
	"citizenIds\x12#\n" +
	"\rinterest_rate\x18\x03 \x01(\x02R\finterestRate\x12\x1a\n" +
	"\bcurrency\x18\x04 \x01(\x02R\bcurrency\"\xf3\x01\n" +
	"\x05Agent\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\x12\x1f\n" +
	"\bcurrency\x18\x02 \x01(\x02H\x00R\bcurrency\x88\x01\x01\x12\x1c\n" +
	"\afirm_id\x18\x03 \x01(\x05H\x01R\x06firmId\x88\x01\x01\x12\x19\n" +
	"\x05skill\x18\x04 \x01(\x02H\x02R\x05skill\x88\x01\x01\x12%\n" +
	"\vconsumption\x18\x05 \x01(\x02H\x03R\vconsumption\x88\x01\x01\x12\x1b\n" +
	"\x06income\x18\x06 \x01(\x02H\x04R\x06income\x88\x01\x01B\v\n" +
	"\t_currencyB\n" +
	"\n" +
	"\b_firm_idB\b\n" +
	"\x06_skillB\x0e\n" +
	...
	"\x05firms\x18\x01 \x03(\v2\x15.city.economy.v2.FirmR\x05firms\x12&\n" +
	"\x03nbs\x18\x02 \x03(\v2\x14.city.economy.v2.NBSR\x03nbs\x12=\n" +
	"\vgovernments\x18\x03 \x03(\v2\x1b.city.economy.v2.GovernmentR\vgovernments\x12+\n" +
	"\x05banks\x18\x04 \x03(\v2\x15.city.economy.v2.BankR\x05banks\x12.\n" +
	"\x06agents\x18\x05 \x03(\v2\x16.city.economy.v2.AgentR\x06agentsB\xbc\x01\n" +
	"\x13com.city.economy.v2B\fEconomyProtoP\x01Z9git.fiblab.net/sim/protos/v2/go/city/economy/v2;economyv2\xa2\x02\x03CEX\xaa\x02\x0fCity.Economy.V2\xca\x02\x0fCity\\Economy\\V2\xe2\x02\x1bCity\\Economy\\V2\\GPBMetadata\xea\x02\x11City::Economy::V2b\x06proto3"
