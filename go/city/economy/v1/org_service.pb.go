...
type GetOrgRequest struct {
	...
	OrgIds []int32 `protobuf:"varint,1,rep,packed,name=org_ids,json=orgIds,proto3" json:"org_ids,omitempty" db:"org_ids" yaml:"org_ids" bson:"org_ids"`
}
...
type UpdateOrgGoodsRequestItem struct {
	...
	Goods []*Goods `protobuf:"bytes,2,rep,name=goods,proto3" json:"goods,omitempty" db:"goods" yaml:"goods" bson:"goods"`
}
...
type UpdateOrgEmployeeRequest struct {
	...
	// 待修改的组织员工变动
	Items []*UpdateOrgEmployeeRequestItem `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty" db:"items" yaml:"items" bson:"items"`
}
...
var file_city_economy_v1_org_service_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x00, 0x42, 0xbc, 0x01, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x69, 0x74, 0x79,
	...
	0x79, 0x2f, 0x65, 0x63, 0x6f, 0x6e, 0x6f, 0x6d, 0x79, 0x2f, 0x76, 0x31, 0x3b, 0x65, 0x63, 0x6f,
	0x6e, 0x6f, 0x6d, 0x79, 0x76, 0x31, 0xa2, 0x02, 0x03, 0x43, 0x45, 0x58, 0xaa, 0x02, 0x0f, 0x43,
	0x69, 0x74, 0x79, 0x2e, 0x45, 0x63, 0x6f, 0x6e, 0x6f, 0x6d, 0x79, 0x2e, 0x56, 0x31, 0xca, 0x02,
	0x0f, 0x43, 0x69, 0x74, 0x79, 0x5c, 0x45, 0x63, 0x6f, 0x6e, 0x6f, 0x6d, 0x79, 0x5c, 0x56, 0x31,
...
var file_city_economy_v1_org_service_proto_goTypes = []interface{}{
...
func file_city_economy_v1_org_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_economy_v1_org_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_city_economy_v1_org_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_city_economy_v1_org_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateOrgMoneyRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_city_economy_v1_org_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateOrgMoneyRequestItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_city_economy_v1_org_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateOrgMoneyResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_city_economy_v1_org_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateOrgGoodsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_city_economy_v1_org_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateOrgGoodsRequestItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_city_economy_v1_org_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateOrgGoodsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_city_economy_v1_org_service_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateOrgEmployeeRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_city_economy_v1_org_service_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateOrgEmployeeRequestItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_city_economy_v1_org_service_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateOrgEmployeeResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_city_economy_v1_org_service_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateOrgJobRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_city_economy_v1_org_service_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateOrgJobRequestItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_city_economy_v1_org_service_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateOrgJobResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
