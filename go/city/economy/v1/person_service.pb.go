...
var file_city_economy_v1_person_service_proto_rawDesc = []byte{
	...
	0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0xbf, 0x01, 0x0a, 0x13,
	...
	,
...
var file_city_economy_v1_person_service_proto_goTypes = []interface{}{
...
func file_city_economy_v1_person_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_economy_v1_person_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_city_economy_v1_person_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_city_economy_v1_person_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdatePersonMoneyRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_city_economy_v1_person_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdatePersonMoneyRequestItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_city_economy_v1_person_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdatePersonMoneyResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
