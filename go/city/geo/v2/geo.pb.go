...
type LongLatBBox struct {
	...
	// 最大经度
	// maximu longitude
	MaxLongitude float64 `protobuf:"fixed64,3,opt,name=max_longitude,json=maxLongitude,proto3" json:"max_longitude,omitempty" db:"max_longitude" yaml:"max_longitude" bson:"max_longitude"`
	// 最大纬度
	// minimum longitude
