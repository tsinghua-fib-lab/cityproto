...
type LongLatBBox struct {
	...
	// 最小经度
	// minimum longitude
	MinLongitude float64 `protobuf:"fixed64,1,opt,name=min_longitude,json=minLongitude,proto3" json:"min_longitude,omitempty" db:"min_longitude" yaml:"min_longitude" bson:"min_longitude"`
	// 最小纬度
	// minimum latitude
