...
const (
	...
	AgentServiceName = "city.traffic.interaction.agent.v2.AgentService"
)
...
const (
	...
	AgentServiceGetAgentProcedure = "/city.traffic.interaction.agent.v2.AgentService/GetAgent"
	// AgentServiceAddAgentProcedure is the fully-qualified name of the AgentService's AddAgent RPC.
	AgentServiceAddAgentProcedure = "/city.traffic.interaction.agent.v2.AgentService/AddAgent"
	// AgentServiceSetScheduleProcedure is the fully-qualified name of the AgentService's SetSchedule
	// RPC.
	AgentServiceSetScheduleProcedure = "/city.traffic.interaction.agent.v2.AgentService/SetSchedule"
	// AgentServiceGetAgentsByLongLatAreaProcedure is the fully-qualified name of the AgentService's
	// GetAgentsByLongLatArea RPC.
	AgentServiceGetAgentsByLongLatAreaProcedure = "/city.traffic.interaction.agent.v2.AgentService/GetAgentsByLongLatArea"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	agentServiceServiceDescriptor                      = v2.File_city_traffic_interaction_agent_v2_agent_service_proto.Services().ByName("AgentService")
...
// AgentServiceClient is a client for the city.traffic.interaction.agent.v2.AgentService service.
...
// NewAgentServiceClient constructs a client for the city.traffic.interaction.agent.v2.AgentService
...
// GetAgent calls city.traffic.interaction.agent.v2.AgentService.GetAgent.
...
// AddAgent calls city.traffic.interaction.agent.v2.AgentService.AddAgent.
...
// SetSchedule calls city.traffic.interaction.agent.v2.AgentService.SetSchedule.
...
// GetAgentsByLongLatArea calls
// city.traffic.interaction.agent.v2.AgentService.GetAgentsByLongLatArea.
...
// AgentServiceHandler is an implementation of the city.traffic.interaction.agent.v2.AgentService
// service.
...
func NewAgentServiceHandler(svc AgentServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/city.traffic.interaction.agent.v2.AgentService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAgentServiceHandler) GetAgent(context.Context, *connect.Request[v2.GetAgentRequest]) (*connect.Response[v2.GetAgentResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("city.traffic.interaction.agent.v2.AgentService.GetAgent is not implemented"))
}
...
func (UnimplementedAgentServiceHandler) AddAgent(context.Context, *connect.Request[v2.AddAgentRequest]) (*connect.Response[v2.AddAgentResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("city.traffic.interaction.agent.v2.AgentService.AddAgent is not implemented"))
}
...
func (UnimplementedAgentServiceHandler) SetSchedule(context.Context, *connect.Request[v2.SetScheduleRequest]) (*connect.Response[v2.SetScheduleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("city.traffic.interaction.agent.v2.AgentService.SetSchedule is not implemented"))
}
...
func (UnimplementedAgentServiceHandler) GetAgentsByLongLatArea(context.Context, *connect.Request[v2.GetAgentsByLongLatAreaRequest]) (*connect.Response[v2.GetAgentsByLongLatAreaResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("city.traffic.interaction.agent.v2.AgentService.GetAgentsByLongLatArea is not implemented"))
}
