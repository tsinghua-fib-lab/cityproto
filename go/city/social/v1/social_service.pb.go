...
var file_city_social_v1_social_service_proto_rawDesc = []byte{
	...
	0x73, 0x69, 0x6d, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x67, 0x6f, 0x2f, 0x76, 0x32,
...
func file_city_social_v1_social_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_social_v1_social_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_city_social_v1_social_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_city_social_v1_social_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_city_social_v1_social_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
