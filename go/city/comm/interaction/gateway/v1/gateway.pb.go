...
var file_city_comm_interaction_gateway_v1_gateway_proto_goTypes = []interface{}{
...
func file_city_comm_interaction_gateway_v1_gateway_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_comm_interaction_gateway_v1_gateway_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
