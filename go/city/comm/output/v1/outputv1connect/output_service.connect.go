...
import (
	...
	context "context"
	errors "errors"
	v1 "git.fiblab.net/sim/protos/v2/go/city/comm/output/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	OutputServiceName = "city.comm.output.v1.OutputService"
)
...
const (
	...
	OutputServiceOutputProcedure = "/city.comm.output.v1.OutputService/Output"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	outputServiceServiceDescriptor      = v1.File_city_comm_output_v1_output_service_proto.Services().ByName("OutputService")
	outputServiceOutputMethodDescriptor = outputServiceServiceDescriptor.Methods().ByName("Output")
)

// OutputServiceClient is a client for the city.comm.output.v1.OutputService service.
...
// NewOutputServiceClient constructs a client for the city.comm.output.v1.OutputService service. By
...
// Output calls city.comm.output.v1.OutputService.Output.
...
// OutputServiceHandler is an implementation of the city.comm.output.v1.OutputService service.
...
func NewOutputServiceHandler(svc OutputServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/city.comm.output.v1.OutputService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedOutputServiceHandler) Output(context.Context, *connect.Request[v1.OutputRequest]) (*connect.Response[v1.OutputResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("city.comm.output.v1.OutputService.Output is not implemented"))
}
