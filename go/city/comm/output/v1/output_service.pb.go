...
var file_city_comm_output_v1_output_service_proto_goTypes = []interface{}{
...
func file_city_comm_output_v1_output_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_comm_output_v1_output_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_city_comm_output_v1_output_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
