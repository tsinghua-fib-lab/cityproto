...
type Node struct {
	...
	Type NodeType `protobuf:"varint,2,opt,name=type,proto3,enum=city.comm.input.v1.NodeType" json:"type,omitempty"`
	// 父节点
	ParentId int32 `protobuf:"varint,3,opt,name=parent_id,json=parentId,proto3" json:"parent_id,omitempty"`
	// 子节点
	ChildrenIds []int32 `protobuf:"varint,4,rep,packed,name=children_ids,json=childrenIds,proto3" json:"children_ids,omitempty"`
	// 节点经纬度位置
	Position *v2.Position `protobuf:"bytes,5,opt,name=position,proto3,oneof" json:"position,omitempty"`
	// 节点所在aoi
	AoiId *int32 `protobuf:"varint,6,opt,name=aoi_id,json=aoiId,proto3,oneof" json:"aoi_id,omitempty"`
	// 基站频段id
	FreqRangeId *int32 `protobuf:"varint,7,opt,name=freq_range_id,json=freqRangeId,proto3,oneof" json:"freq_range_id,omitempty"`
	// 室内外基站类型
	BaseStationType *BaseStationType `protobuf:"varint,8,opt,name=base_station_type,json=baseStationType,proto3,enum=city.comm.input.v1.BaseStationType,oneof" json:"base_station_type,omitempty"`
}
...
type RepairStation struct {
	...
	Id       int32        `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	AoiId    int32        `protobuf:"varint,2,opt,name=aoi_id,json=aoiId,proto3" json:"aoi_id,omitempty"`
...
type CommDemand struct {
	...
	Id      int32     `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	Demands []float64 `protobuf:"fixed64,2,rep,packed,name=demands,proto3" json:"demands,omitempty"`
}
...
type Nodes struct {
	...
	RepairStations []*RepairStation `protobuf:"bytes,2,rep,name=repair_stations,json=repairStations,proto3" json:"repair_stations,omitempty"`
	Pumps          []*Pump          `protobuf:"bytes,3,rep,name=pumps,proto3" json:"pumps,omitempty"`
}
...
type CommDemands struct {
	...
	CommDemands []*CommDemand `protobuf:"bytes,1,rep,name=comm_demands,json=commDemands,proto3" json:"comm_demands,omitempty"`
}
