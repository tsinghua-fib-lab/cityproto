...
type GetAgentsByLongLatAreaResponse struct {
	...
	// 当前模拟步数
	Step int32 `protobuf:"varint,1,opt,name=step,proto3" json:"step,omitempty" bson:"step" db:"step" yaml:"step"`
	// 区域内的agent的运动信息
...
var file_city_agent_v2_agent_service_proto_goTypes = []any{
...
func file_city_agent_v2_agent_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_agent_v2_agent_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_city_agent_v2_agent_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_city_agent_v2_agent_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_city_agent_v2_agent_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_city_agent_v2_agent_service_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_city_agent_v2_agent_service_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_city_agent_v2_agent_service_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_city_agent_v2_agent_service_proto_msgTypes[7].Exporter = func(v any, i int) any {
