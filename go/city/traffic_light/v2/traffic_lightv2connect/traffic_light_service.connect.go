...
const (
	...
	TrafficLightServiceName = "city.traffic_light.v2.TrafficLightService"
)
...
const (
	...
	TrafficLightServiceGetTrafficLightProcedure = "/city.traffic_light.v2.TrafficLightService/GetTrafficLight"
	// TrafficLightServiceSetTrafficLightProcedure is the fully-qualified name of the
	// TrafficLightService's SetTrafficLight RPC.
	TrafficLightServiceSetTrafficLightProcedure = "/city.traffic_light.v2.TrafficLightService/SetTrafficLight"
	...
	TrafficLightServiceSetTrafficLightPhaseProcedure = "/city.traffic_light.v2.TrafficLightService/SetTrafficLightPhase"
	...
	TrafficLightServiceSetTrafficLightStatusProcedure = "/city.traffic_light.v2.TrafficLightService/SetTrafficLightStatus"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	trafficLightServiceServiceDescriptor                     = v2.File_city_traffic_light_v2_traffic_light_service_proto.Services().ByName("TrafficLightService")
...
// city.traffic_light.v2.TrafficLightService service. By default, it uses the Connect protocol with
...
// GetTrafficLight calls city.traffic_light.v2.TrafficLightService.GetTrafficLight.
...
// SetTrafficLight calls city.traffic_light.v2.TrafficLightService.SetTrafficLight.
...
// SetTrafficLightPhase calls city.traffic_light.v2.TrafficLightService.SetTrafficLightPhase.
...
// SetTrafficLightStatus calls city.traffic_light.v2.TrafficLightService.SetTrafficLightStatus.
...
// TrafficLightServiceHandler is an implementation of the city.traffic_light.v2.TrafficLightService
// service.
...
func NewTrafficLightServiceHandler(svc TrafficLightServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/city.traffic_light.v2.TrafficLightService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTrafficLightServiceHandler) GetTrafficLight(context.Context, *connect.Request[v2.GetTrafficLightRequest]) (*connect.Response[v2.GetTrafficLightResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("city.traffic_light.v2.TrafficLightService.GetTrafficLight is not implemented"))
}
...
func (UnimplementedTrafficLightServiceHandler) SetTrafficLight(context.Context, *connect.Request[v2.SetTrafficLightRequest]) (*connect.Response[v2.SetTrafficLightResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("city.traffic_light.v2.TrafficLightService.SetTrafficLight is not implemented"))
}
...
func (UnimplementedTrafficLightServiceHandler) SetTrafficLightPhase(context.Context, *connect.Request[v2.SetTrafficLightPhaseRequest]) (*connect.Response[v2.SetTrafficLightPhaseResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("city.traffic_light.v2.TrafficLightService.SetTrafficLightPhase is not implemented"))
}
...
func (UnimplementedTrafficLightServiceHandler) SetTrafficLightStatus(context.Context, *connect.Request[v2.SetTrafficLightStatusRequest]) (*connect.Response[v2.SetTrafficLightStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("city.traffic_light.v2.TrafficLightService.SetTrafficLightStatus is not implemented"))
}
