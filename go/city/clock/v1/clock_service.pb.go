...
func file_city_clock_v1_clock_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_clock_v1_clock_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_city_clock_v1_clock_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
