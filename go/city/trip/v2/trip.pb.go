...
type TripStop struct {
	...
	LanePosition *v2.LanePosition `protobuf:"bytes,2,opt,name=lane_position,json=lanePosition,proto3" json:"lane_position,omitempty" db:"lane_position" yaml:"lane_position" bson:"lane_position"`
	// 停车持续时间
