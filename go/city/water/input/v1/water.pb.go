...
type RainPeriod struct {
	...
	// 降雨量：单位mm
	Rainfall float64 `protobuf:"fixed64,2,opt,name=rainfall,proto3" json:"rainfall,omitempty"`
}
...
type Rain struct {
	...
	Rains []*RainPeriod `protobuf:"bytes,1,rep,name=rains,proto3" json:"rains,omitempty"`
}
...
var file_city_water_input_v1_water_proto_goTypes = []interface{}{
...
func file_city_water_input_v1_water_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_water_input_v1_water_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_city_water_input_v1_water_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Rain); i {
			case 0:
				return &v.state
			case 1:
