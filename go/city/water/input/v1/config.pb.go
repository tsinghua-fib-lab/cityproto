...
type Mongo struct {
	...
	Rain *v1.MongoPath `protobuf:"bytes,3,opt,name=rain,proto3" json:"rain,omitempty"`
}
...
type OutputSwitch struct {
	...
	Road     bool `protobuf:"varint,1,opt,name=road,proto3" json:"road,omitempty"`
	Drainage bool `protobuf:"varint,2,opt,name=drainage,proto3" json:"drainage,omitempty"`
	Supply   bool `protobuf:"varint,3,opt,name=supply,proto3" json:"supply,omitempty"`
	Aoi      bool `protobuf:"varint,4,opt,name=aoi,proto3" json:"aoi,omitempty"`
	Event    bool `protobuf:"varint,5,opt,name=event,proto3" json:"event,omitempty"`
}
...
var file_city_water_input_v1_config_proto_goTypes = []interface{}{
...
func file_city_water_input_v1_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_water_input_v1_config_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Mongo); i {
			case 0:
				return &v.state
			case 1:
		...
		file_city_water_input_v1_config_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_city_water_input_v1_config_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_city_water_input_v1_config_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_city_water_input_v1_config_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Output); i {
			case 0:
				return &v.state
			case 1:
		...
		file_city_water_input_v1_config_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
