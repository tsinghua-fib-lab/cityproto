...
func file_city_water_input_v1_input_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_water_input_v1_input_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_city_water_input_v1_input_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
