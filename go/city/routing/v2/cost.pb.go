...
var file_city_routing_v2_cost_proto_rawDesc = []byte{
	...
	0x2f, 0x73, 0x69, 0x6d, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x67, 0x6f, 0x2f, 0x76,
	0x32, 0x2f, 0x63, 0x69, 0x74, 0x79, 0x2f, 0x72, 0x6f, 0x75, 0x74, 0x69, 0x6e, 0x67, 0x2f, 0x76,
...
func file_city_routing_v2_cost_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_routing_v2_cost_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Cost); i {
			case 0:
				return &v.state
			case 1:
