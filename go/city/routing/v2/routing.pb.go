...
const (
	...
	// 出租车
	// by taxi
	RouteType_ROUTE_TYPE_TAXI RouteType = 6
)
...
const (
	...
	// 出租车
	// taking taxi
	JourneyType_JOURNEY_TYPE_BY_TAXI JourneyType = 4
)
...
const file_city_routing_v2_routing_proto_rawDesc = "" +
	...
	"\x0eend_station_id\x18\x03 \x01(\x05R\fendStationId\"b\n" +
	"\x0eBusJourneyBody\x12>\n" +
	"\ttransfers\x18\x01 \x03(\v2 .city.routing.v2.TransferSegmentR\ttransfers\x12\x10\n" +
	"\x03eta\x18\x02 \x01(\x01R\x03eta\"\xa3\x02\n" +
	"\aJourney\x120\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1c.city.routing.v2.JourneyTypeR\x04type\x12B\n" +
	"\adriving\x18\x02 \x01(\v2#.city.routing.v2.DrivingJourneyBodyH\x00R\adriving\x88\x01\x01\x12B\n" +
	"\awalking\x18\x03 \x01(\v2#.city.routing.v2.WalkingJourneyBodyH\x01R\awalking\x88\x01\x01\x12;\n" +
	"\x06by_bus\x18\x04 \x01(\v2\x1f.city.routing.v2.BusJourneyBodyH\x02R\x05byBus\x88\x01\x01B\n" +
	"\n" +
	"\b_drivingB\n" +
	"\n" +
	"\b_walkingB\t\n" +
	...
	"\fRoadStatuses\x12@\n" +
	"\rroad_statuses\x18\x01 \x03(\v2\x1b.city.routing.v2.RoadStatusR\froadStatuses*\xb2\x01\n" +
	"\tRouteType\x12\x1a\n" +
	...
	"\x13com.city.routing.v2B\fRoutingProtoP\x01Z9git.fiblab.net/sim/protos/v2/go/city/routing/v2;routingv2\xa2\x02\x03CRX\xaa\x02\x0fCity.Routing.V2\xca\x02\x0fCity\\Routing\\V2\xe2\x02\x1bCity\\Routing\\V2\\GPBMetadata\xea\x02\x11City::Routing::V2b\x06proto3"

var (
	file_city_routing_v2_routing_proto_rawDescOnce sync.Once
	file_city_routing_v2_routing_proto_rawDescData []byte
)

func file_city_routing_v2_routing_proto_rawDescGZIP() []byte {
	file_city_routing_v2_routing_proto_rawDescOnce.Do(func() {
		file_city_routing_v2_routing_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_city_routing_v2_routing_proto_rawDesc), len(file_city_routing_v2_routing_proto_rawDesc)))
	})
...
func file_city_routing_v2_routing_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_city_routing_v2_routing_proto_rawDesc), len(file_city_routing_v2_routing_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
