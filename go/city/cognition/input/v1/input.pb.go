...
var file_city_cognition_input_v1_input_proto_goTypes = []interface{}{
...
func file_city_cognition_input_v1_input_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_cognition_input_v1_input_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Edge); i {
			case 0:
				return &v.state
			case 1:
		...
		file_city_cognition_input_v1_input_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Edges); i {
			case 0:
				return &v.state
			case 1:
