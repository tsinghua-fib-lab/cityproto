...
import (
	...
	context "context"
	errors "errors"
	v1 "git.fiblab.net/sim/protos/go/city/cognition/input/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	InputServiceName = "city.cognition.input.v1.InputService"
)
...
const (
	...
	InputServiceInitProcedure = "/city.cognition.input.v1.InputService/Init"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	inputServiceServiceDescriptor    = v1.File_city_cognition_input_v1_input_service_proto.Services().ByName("InputService")
	inputServiceInitMethodDescriptor = inputServiceServiceDescriptor.Methods().ByName("Init")
)

// InputServiceClient is a client for the city.cognition.input.v1.InputService service.
...
// NewInputServiceClient constructs a client for the city.cognition.input.v1.InputService service.
...
// Init calls city.cognition.input.v1.InputService.Init.
...
// InputServiceHandler is an implementation of the city.cognition.input.v1.InputService service.
...
func NewInputServiceHandler(svc InputServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/city.cognition.input.v1.InputService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedInputServiceHandler) Init(context.Context, *connect.Request[v1.InitRequest]) (*connect.Response[v1.InitResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("city.cognition.input.v1.InputService.Init is not implemented"))
}
