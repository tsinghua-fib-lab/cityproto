...
import (
	...
	context "context"
	errors "errors"
	v1 "git.fiblab.net/sim/protos/go/city/cognition/output/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	OutputServiceName = "city.cognition.output.v1.OutputService"
)
...
const (
	...
	OutputServiceOutputProcedure = "/city.cognition.output.v1.OutputService/Output"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	outputServiceServiceDescriptor      = v1.File_city_cognition_output_v1_output_service_proto.Services().ByName("OutputService")
	outputServiceOutputMethodDescriptor = outputServiceServiceDescriptor.Methods().ByName("Output")
)

// OutputServiceClient is a client for the city.cognition.output.v1.OutputService service.
...
// NewOutputServiceClient constructs a client for the city.cognition.output.v1.OutputService
...
// Output calls city.cognition.output.v1.OutputService.Output.
...
// OutputServiceHandler is an implementation of the city.cognition.output.v1.OutputService service.
...
func NewOutputServiceHandler(svc OutputServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/city.cognition.output.v1.OutputService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedOutputServiceHandler) Output(context.Context, *connect.Request[v1.OutputRequest]) (*connect.Response[v1.OutputResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("city.cognition.output.v1.OutputService.Output is not implemented"))
}
