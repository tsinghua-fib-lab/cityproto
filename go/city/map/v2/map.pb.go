...
type Lane struct {
	...
	Length float64 `protobuf:"fixed64,5,opt,name=length,proto3" json:"length,omitempty" db:"length" yaml:"length" bson:"length"`
	// 车道宽度（单位：米）
	...
	LeftBorderLine *Polyline `protobuf:"bytes,8,opt,name=left_border_line,json=leftBorderLine,proto3" json:"left_border_line,omitempty" yaml:"left_border_line" bson:"left_border_line" db:"left_border_line"` // 弃用 deprecated
	// 车道右边界线
	...
	ParentId int32 `protobuf:"varint,14,opt,name=parent_id,json=parentId,proto3" json:"parent_id,omitempty" db:"parent_id" yaml:"parent_id" bson:"parent_id"`
	...
	Overlaps []*LaneOverlap `protobuf:"bytes,15,rep,name=overlaps,proto3" json:"overlaps,omitempty" db:"overlaps" yaml:"overlaps" bson:"overlaps"`
	// 连接到该车道的所有AOI
...
type Road struct {
	...
	NextRoadLanePlans []*NextRoadLanePlan `protobuf:"bytes,3,rep,name=next_road_lane_plans,json=nextRoadLanePlans,proto3" json:"next_road_lane_plans,omitempty" db:"next_road_lane_plans" yaml:"next_road_lane_plans" bson:"next_road_lane_plans"`
}
...
type JunctionLaneGroup struct {
	...
	OutRoadId int32 `protobuf:"varint,3,opt,name=out_road_id,json=outRoadId,proto3" json:"out_road_id,omitempty" db:"out_road_id" yaml:"out_road_id" bson:"out_road_id"`
	// 该车道组的出口角度（弧度制）
	// The exit angle of this lane group (in radians)
	OutAngle float64 `protobuf:"fixed64,4,opt,name=out_angle,json=outAngle,proto3" json:"out_angle,omitempty" db:"out_angle" yaml:"out_angle" bson:"out_angle"`
	// 该车道组包含的车道
	// Lanes in the group
...
type Junction struct {
	...
	Phases []*AvailablePhase `protobuf:"bytes,4,rep,name=phases,proto3" json:"phases,omitempty" db:"phases" yaml:"phases" bson:"phases"`
	// 默认固定相位信号灯
...
type SublineSchedules struct {
	...
	DepartureTimes []float64 `protobuf:"fixed64,1,rep,packed,name=departure_times,json=departureTimes,proto3" json:"departure_times,omitempty" yaml:"departure_times" bson:"departure_times" db:"departure_times"`
	// 到达沿途站点预计时间
...
type HeuristicTAZCost struct {
	...
	TazXId int32   `protobuf:"varint,1,opt,name=taz_x_id,json=tazXId,proto3" json:"taz_x_id,omitempty" db:"taz_x_id" yaml:"taz_x_id" bson:"taz_x_id"`
...
type Aoi struct {
	...
	UrbanLandUse *string `protobuf:"bytes,12,opt,name=urban_land_use,json=urbanLandUse,proto3,oneof" json:"urban_land_use,omitempty" yaml:"urban_land_use" bson:"urban_land_use" db:"urban_land_use"`
	// Aoi包含的Poi
...
type Map struct {
	...
	Header    *Header                   `protobuf:"bytes,1,opt,name=header,proto3" json:"header,omitempty" db:"header" yaml:"header" bson:"header"`
...
var file_city_map_v2_map_proto_rawDesc = []byte{
	...
	0x50, 0x45, 0x5f, 0x53, 0x55, 0x42, 0x57, 0x41, 0x59, 0x10, 0x02, 0x42, 0x99, 0x01, 0x0a, 0x0f,
	0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x69, 0x74, 0x79, 0x2e, 0x6d, 0x61, 0x70, 0x2e, 0x76, 0x32, 0x42,
	0x08, 0x4d, 0x61, 0x70, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2e, 0x67, 0x69, 0x74,
	0x2e, 0x66, 0x69, 0x62, 0x6c, 0x61, 0x62, 0x2e, 0x6e, 0x65, 0x74, 0x2f, 0x73, 0x69, 0x6d, 0x2f,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x67, 0x6f, 0x2f, 0x63, 0x69, 0x74, 0x79, 0x2f, 0x6d,
...
func file_city_map_v2_map_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_map_v2_map_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_city_map_v2_map_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Header); i {
			case 0:
				return &v.state
			case 1:
		...
		file_city_map_v2_map_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_city_map_v2_map_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_city_map_v2_map_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Lane); i {
			case 0:
				return &v.state
			case 1:
		...
		file_city_map_v2_map_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_city_map_v2_map_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_city_map_v2_map_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*Road); i {
			case 0:
				return &v.state
			case 1:
		...
		file_city_map_v2_map_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_city_map_v2_map_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_city_map_v2_map_proto_msgTypes[10].Exporter = func(v any, i int) any {
			switch v := v.(*RoadIds); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_city_map_v2_map_proto_msgTypes[11].Exporter = func(v any, i int) any {
			switch v := v.(*SublineSchedules); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_city_map_v2_map_proto_msgTypes[12].Exporter = func(v any, i int) any {
			switch v := v.(*HeuristicTAZCost); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_city_map_v2_map_proto_msgTypes[13].Exporter = func(v any, i int) any {
			switch v := v.(*PublicTransportSubline); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_city_map_v2_map_proto_msgTypes[14].Exporter = func(v any, i int) any {
			switch v := v.(*SublineDrivingLanePair); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_city_map_v2_map_proto_msgTypes[15].Exporter = func(v any, i int) any {
			switch v := v.(*Aoi); i {
			case 0:
				return &v.state
			case 1:
		...
		file_city_map_v2_map_proto_msgTypes[16].Exporter = func(v any, i int) any {
			switch v := v.(*Poi); i {
			case 0:
				return &v.state
			case 1:
		...
		file_city_map_v2_map_proto_msgTypes[17].Exporter = func(v any, i int) any {
			switch v := v.(*Map); i {
			case 0:
				return &v.state
			case 1:
