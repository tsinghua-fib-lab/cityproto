...
type Header struct {
	...
	TazYStep *float64 `protobuf:"fixed64,9,opt,name=taz_y_step,json=tazYStep,proto3,oneof" json:"taz_y_step,omitempty" db:"taz_y_step" yaml:"taz_y_step" bson:"taz_y_step"`
}
