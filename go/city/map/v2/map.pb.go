...
type Lane struct {
	...
	//
	// Deprecated: Marked as deprecated in city/map/v2/map.proto.
	RightBorderLine *Polyline `protobuf:"bytes,9,opt,name=right_border_line,json=rightBorderLine,proto3" json:"right_border_line,omitempty" db:"right_border_line" yaml:"right_border_line" bson:"right_border_line"` // 弃用 deprecated
...
type Road struct {
	...
	// 道路名字
	// road name
	Name string `protobuf:"bytes,4,opt,name=name,proto3" json:"name,omitempty" db:"name" yaml:"name" bson:"name"`
...
type Aoi struct {
	...
	//
	// Deprecated: Marked as deprecated in city/map/v2/map.proto.
	Type AoiType `protobuf:"varint,2,opt,name=type,proto3,enum=city.map.v2.AoiType" json:"type,omitempty" db:"type" yaml:"type" bson:"type"`
	// Aoi与行车路网的连接点
