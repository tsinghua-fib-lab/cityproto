...
func file_city_map_v2_light_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_map_v2_light_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Phase); i {
			case 0:
				return &v.state
			case 1:
		...
		file_city_map_v2_light_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_city_map_v2_light_proto_msgTypes[2].Exporter = func(v any, i int) any {
