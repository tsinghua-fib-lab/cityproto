...
var file_city_map_v2_light_proto_rawDesc = []byte{
	...
	0x54, 0x45, 0x5f, 0x59, 0x45, 0x4c, 0x4c, 0x4f, 0x57, 0x10, 0x03, 0x42, 0x9b, 0x01, 0x0a, 0x0f,
	0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x69, 0x74, 0x79, 0x2e, 0x6d, 0x61, 0x70, 0x2e, 0x76, 0x32, 0x42,
	0x0a, 0x4c, 0x69, 0x67, 0x68, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2e, 0x67,
...
var file_city_map_v2_light_proto_goTypes = []interface{}{
...
func file_city_map_v2_light_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_city_map_v2_light_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Phase); i {
			case 0:
				return &v.state
			case 1:
		...
		file_city_map_v2_light_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AvailablePhase); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_city_map_v2_light_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
